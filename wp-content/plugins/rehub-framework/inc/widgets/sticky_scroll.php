...
class rehub_sticky_on_scroll extends WP_Widget {
    ...
    function __construct() {
		$widget_ops = array( 'classname' => 'stickyscroll_widget', 'description' => __('Widget that sticks after sidebar scroll. Use only in sidebar!', 'rehub-framework') );
		$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'rehub_sticky_on_scroll' );
        parent::__construct('rehub_sticky_on_scroll', __('ReHub: Sticky on scroll', 'rehub-framework'), $widget_ops, $control_ops  );
    }
...
function widget( $args, $instance ) {
	...
	function form( $instance ) {
		...
		<p><em style="color:red;"><?php _e('Use this widget only once and only in sidebar area!', 'rehub-framework');?></em></p>
		<p>
