...
class rehub_tabsajax_widget extends WP_Widget {
    ...
    function __construct() {
		$widget_ops = array( 'classname' => 'tabsajax', 'description' => __('A widget that displays 4 ajax tabs. Use only in sidebar! ', 'rehub-framework') );
		$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'rehub_tabsajax_widget' );
        parent::__construct('rehub_tabsajax_widget', __('ReHub: Ajax Tabs', 'rehub-framework'), $widget_ops, $control_ops  );
    }
	...
	function form( $instance ) {
		...
		<div>
		<p><em style="color:red;"><?php _e('Use this widget only in sidebar area!', 'rehub-framework');?></em></p>
		<p>
			<label for="<?php echo ''.$this->get_field_id( 'title' ); ?>"><?php _e('Title of widget:', 'rehub-framework'); ?></label>
			<input  type="text" class="widefat" id="<?php echo ''.$this->get_field_id( 'title' ); ?>" name="<?php echo ''.$this->get_field_name( 'title' ); ?>" value="<?php echo ''.$instance['title']; ?>"  />
		</p>				
		<p>
			<label for="<?php echo ''.$this->get_field_id( 'titlefirst' ); ?>"><?php _e('Enter title for first tab:', 'rehub-framework'); ?></label>
			...
			<span><em><?php _e('Required', 'rehub-framework');?></em></span>
		</p>
		<p>
		<label for="<?php echo ''.$this->get_field_id('datefirst'); ?>"><?php _e('Show posts for first tab published:', 'rehub-framework');?></label> 
		<select id="<?php echo ''.$this->get_field_id('datefirst'); ?>" name="<?php echo ''.$this->get_field_name('datefirst'); ?>" style="width:100%;">
			<option value='all' <?php if ( 'all' == $instance['datefirst'] ) : echo 'selected="selected"'; endif; ?>><?php _e('all time', 'rehub-framework');?></option>
			<option value='day' <?php if ( 'day' == $instance['datefirst'] ) : echo 'selected="selected"'; endif; ?>><?php _e('For last 24 hours', 'rehub-framework');?></option>			
			<option value='week' <?php if ( 'week' == $instance['datefirst'] ) : echo 'selected="selected"'; endif; ?>><?php _e('For last 7 days', 'rehub-framework');?></option>
			<option value='month' <?php if ( 'month' == $instance['datefirst'] ) : echo 'selected="selected"'; endif; ?>><?php _e('For last month', 'rehub-framework');?></option>
			<option value='year' <?php if ( 'year' == $instance['datefirst'] ) : echo 'selected="selected"'; endif; ?>><?php _e('For last year', 'rehub-framework');?></option>
		</select>
		</p>		
		<p>
			<label for="<?php echo ''.$this->get_field_id( 'metafirst' ); ?>"><?php _e('Enter meta for first tab', 'rehub-framework'); ?></label>
		...
		<p>
		<label for="<?php echo ''.$this->get_field_id('datesecond'); ?>"><?php _e('Show posts for second tab published:', 'rehub-framework');?></label> 
		<select id="<?php echo ''.$this->get_field_id('datesecond'); ?>" name="<?php echo ''.$this->get_field_name('datesecond'); ?>" style="width:100%;">
			<option value='all' <?php if ( 'all' == $instance['datesecond'] ) : echo 'selected="selected"'; endif; ?>><?php _e('all time', 'rehub-framework');?></option>
			<option value='day' <?php if ( 'day' == $instance['datesecond'] ) : echo 'selected="selected"'; endif; ?>><?php _e('For last 24 hours', 'rehub-framework');?></option>			
			<option value='week' <?php if ( 'week' == $instance['datesecond'] ) : echo 'selected="selected"'; endif; ?>><?php _e('For last 7 days', 'rehub-framework');?></option>
			<option value='month' <?php if ( 'month' == $instance['datesecond'] ) : echo 'selected="selected"'; endif; ?>><?php _e('For last month', 'rehub-framework');?></option>
			<option value='year' <?php if ( 'year' == $instance['datesecond'] ) : echo 'selected="selected"'; endif; ?>><?php _e('For last year', 'rehub-framework');?></option>
		</select>
		</p>		
		<p>
			<label for="<?php echo ''.$this->get_field_id( 'metasecond' ); ?>"><?php _e('Enter meta for second tab', 'rehub-framework'); ?></label>
		...
		<hr style="margin: 30px 0" />
		<p>
			<label for="<?php echo ''.$this->get_field_id( 'titlethird' ); ?>"><?php _e('Enter title for third tab', 'rehub-framework'); ?></label>
		...
		<p>
		<label for="<?php echo ''.$this->get_field_id('datethird'); ?>"><?php _e('Show posts for third tab published:', 'rehub-framework');?></label> 
		<select id="<?php echo ''.$this->get_field_id('datethird'); ?>" name="<?php echo ''.$this->get_field_name('datethird'); ?>" style="width:100%;">
			<option value='all' <?php if ( 'all' == $instance['datethird'] ) : echo 'selected="selected"'; endif; ?>><?php _e('all time', 'rehub-framework');?></option>
			<option value='day' <?php if ( 'day' == $instance['datethird'] ) : echo 'selected="selected"'; endif; ?>><?php _e('For last 24 hours', 'rehub-framework');?></option>			
			<option value='week' <?php if ( 'week' == $instance['datethird'] ) : echo 'selected="selected"'; endif; ?>><?php _e('For last 7 days', 'rehub-framework');?></option>
			<option value='month' <?php if ( 'month' == $instance['datethird'] ) : echo 'selected="selected"'; endif; ?>><?php _e('For last month', 'rehub-framework');?></option>
			<option value='year' <?php if ( 'year' == $instance['datethird'] ) : echo 'selected="selected"'; endif; ?>><?php _e('For last year', 'rehub-framework');?></option>
		</select>
		</p>		
		<p>
			<label for="<?php echo ''.$this->get_field_id( 'metathird' ); ?>"><?php _e('Enter meta for third tab', 'rehub-framework'); ?></label>
		...
		<hr style="margin: 30px 0" />
		<p>
			<label for="<?php echo ''.$this->get_field_id( 'titlefourth' ); ?>"><?php _e('Enter title for fourth tab', 'rehub-framework'); ?></label>
		...
		<p>
		<label for="<?php echo ''.$this->get_field_id('datefourth'); ?>"><?php _e('Show posts for fourth tab published:', 'rehub-framework');?></label> 
		<select id="<?php echo ''.$this->get_field_id('datefourth'); ?>" name="<?php echo ''.$this->get_field_name('datefourth'); ?>" style="width:100%;">
			<option value='all' <?php if ( 'all' == $instance['datefourth'] ) : echo 'selected="selected"'; endif; ?>><?php _e('all time', 'rehub-framework');?></option>
			<option value='day' <?php if ( 'day' == $instance['datefourth'] ) : echo 'selected="selected"'; endif; ?>><?php _e('For last 24 hours', 'rehub-framework');?></option>			
			<option value='week' <?php if ( 'week' == $instance['datefourth'] ) : echo 'selected="selected"'; endif; ?>><?php _e('For last 7 days', 'rehub-framework');?></option>
			<option value='month' <?php if ( 'month' == $instance['datefourth'] ) : echo 'selected="selected"'; endif; ?>><?php _e('For last month', 'rehub-framework');?></option>
			<option value='year' <?php if ( 'year' == $instance['datefourth'] ) : echo 'selected="selected"'; endif; ?>><?php _e('For last year', 'rehub-framework');?></option>
		</select>
		</p>		
		<p>
			<label for="<?php echo ''.$this->get_field_id( 'metafourth' ); ?>"><?php _e('Enter meta for fourth tab', 'rehub-framework'); ?></label>
		...
		<p style="font-style: italic;">
			<?php _e('Some important meta keys: <br /><strong>rehub_review_overall_score</strong> - key for overall review score, <br /><strong>post_hot_count</strong> - hot or thumb counter, <br /><strong>post_wish_count</strong> - wishlist counter, <br /><strong>post_user_average</strong> - user rating score(based on full review criterias), <br /><strong>rehub_views</strong> - post view counter, <br /><strong>rehub_views_mon, rehub_views_day, rehub_views_year</strong> - post view counter by day, month, year <br />', 'rehub-framework')?>								
		</p>
		<p>
			<label for="<?php echo ''.$this->get_field_id( 'hotenable' ); ?>"><?php _e('Show Hot counter?', 'rehub-framework'); ?></label>
		...
		<p>
			<label for="<?php echo ''.$this->get_field_id( 'priceenable' ); ?>"><?php _e('Show price', 'rehub-framework'); ?></label>
