...
class related_review_widget extends WP_Widget {
    ...
    function __construct() {
		$widget_ops = array( 'classname' => 'posts_widget', 'description' => __('A widget that displays related reviews. Works only on single review post page', 'rehub-framework') );
		$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'related_review_widget' );
        parent::__construct('related_review_widget', __('ReHub: Related Reviews', 'rehub-framework'), $widget_ops, $control_ops);
    }
...
if(is_singular('post')) :
	...
	function form( $instance ) {
		...
		$defaults = array( 'title' => __('Related reviews', 'rehub-framework'), 'number' => 5);
