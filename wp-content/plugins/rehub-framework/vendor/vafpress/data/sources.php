...
function vp_get_gwf_family()
{
	...
	$fonts = json_decode(rf_filesystem('get_content', dirname(__FILE__) . '/gwf.json')); 
...
function vp_get_fontawesome_icons()
{
	...
	if( false === ( $icons  = get_transient( 'vp_fontawesome_icons' ) ) )
	{
		...
		$subject = rf_filesystem('get_content', get_template_directory_uri() . '/admin/fonts/fontawesome/font-awesome.min.css');
