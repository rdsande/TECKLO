...
class RH_Meta_Box_Post {
	...
	public static function meta_for_posts() {
		$post_custom_meta_fields = apply_filters('rh_post_custom_meta_fields', array(
		    array(
		        ...
		        'desc'  => __('Insert url of offer', 'rehub-framework'),
		        'id'    => 'rehub_offer_product_url',
		        'type'  => 'text'
		    ),	
		    array(
		        'label'=>  __('Name of product', 'rehub-framework'),
		        'desc'  => __('Insert title or leave blank', 'rehub-framework'),
		        'id'    => 'rehub_offer_name',
		        'type'  => 'text'
		    ),
		    array(
		        'label'=>  __('Short description of product', 'rehub-framework'),
		        'desc'  => __('Enter description of product or leave blank', 'rehub-framework'),
		        'id'    => 'rehub_offer_product_desc',
		        'type'  => 'text'
		    ), 
		    array(
		        'label'=>  __('Disclaimer', 'rehub-framework'),
		        'desc'  => __('Optional. It works in [quick_offer] and [wpsm_top] shortcodes', 'rehub-framework'),
		        'id'    => 'rehub_offer_disclaimer',
		        'type'  => 'textbox'
		    ),    
		    array(
		        'label'=>  __('Offer old price', 'rehub-framework'),
		        'desc'  => __('Insert old price of offer or leave blank', 'rehub-framework'),
		        'id'    => 'rehub_offer_product_price_old',
		        'type'  => 'text'
		    ), 
		    array(
		        'label'=>  __('Offer sale price', 'rehub-framework'),
		        'desc'  => __('Insert sale price of offer (example, $55). Please, choose your price pattern in theme options - localizations', 'rehub-framework'),
		        'id'    => 'rehub_offer_product_price',
		        'type'  => 'text'
		    ),  
		    array(
		        'label'=>  __('Set coupon code', 'rehub-framework'),
		        'desc'  => __('Set coupon code or leave blank', 'rehub-framework'),
		        'id'    => 'rehub_offer_product_coupon',
		        'type'  => 'text'
		    ),            
			array(
			    'label' => __('Expiration Date', 'rehub-framework'),
			    'desc'  => __('Choose expiration date or leave blank', 'rehub-framework'),
			    'id'    => 'rehub_offer_coupon_date',
			    'type'  => 'date'
			),    
		    array(
		        'label'=> __('Mask coupon code?', 'rehub-framework'),
		        'desc'  => __('If this option is enabled, coupon code will be hidden.', 'rehub-framework'),
		        'id'    => 'rehub_offer_coupon_mask',
		        'type'  => 'checkbox'
		    ),
		    array(
		        'label'=> __('Offer is expired?', 'rehub-framework'),
		        'desc'  => __('This option depends on expiration date field, but you can also enable expiration if you have not expiration date', 'rehub-framework'),
		        'id'    => 're_post_expired',
		        'type'  => 'checkbox'
		    ),    
		    array(
		        'label'=> __('Button text', 'rehub-framework'),
		        'desc'  => __('Insert text on button or leave blank to use default text. Use short names (not more than 14 symbols)', 'rehub-framework'),
		        'id'    => 'rehub_offer_btn_text',
		        'type'  => 'text'
		    ),     
			array(
			    'label'  => __('Upload thumbnail', 'rehub-framework'),
			    'desc'  => __('Upload thumbnail of product or leave blank to use post thumbnail', 'rehub-framework'),
			    'id'    => 'rehub_offer_product_thumb',
			    'type'  => 'image'
			),
		    array(
		        'label'=> __('Brand logo url', 'rehub-framework'),
		        'desc'  => __('Fallback for brand logo (better to add brand logo in Affiliate store fields)', 'rehub-framework'),
		        'id'    => 'rehub_offer_logo_url',
		        'type'  => 'text'
		    ), 
		    array(
		        'label'=>  __('Offer currency', 'rehub-framework'),
		        'desc'  => __('Currency in ISO 4217. This is only for schema markup. Example: USD or EUR', 'rehub-framework'),
		        'id'    => 'rehub_main_product_currency',
		        'type'  => 'text'
		    ),       	
		    array(
		        'label'=> __('Shortcode for this offer section', 'rehub-framework'),
		...
		if (defined('\ContentEgg\PLUGIN_PATH')){
		    $post_custom_meta_fields[] =  array(
		        'label'=> __('Synchronization with Content Egg', 'rehub-framework'),
	...
	public static function meta_for_products() {
		$woo_custom_meta_fields = apply_filters('rh_woo_custom_meta_fields', array(
			...
			array(
			    'label' => __('Offer End Date', 'rehub-framework'),
			    'desc'  => __('Choose expiration date of product or leave blank', 'rehub-framework'),
		    ...
		    array(
		        'label'=> __('Brand logo url', 'rehub-framework'),
		        'desc'  => __('Fallback for brand logo (better to add brand logo in Products - Brands fields)', 'rehub-framework'),
		        'id'    => 'rehub_woo_coupon_logo_url',
		        'type'  => 'text'
		    ),
			array(
		        'label'=> __('Additional coupon image url', 'rehub-framework'),
		        'desc'  => __('Used for printable coupon function. To enable it, you must have any coupon code above', 'rehub-framework'),
	...
	public static function meta_for_brand_cat() {
		$rh_woostore_tax_meta = apply_filters('rhwoostore_tax_fields', array(
		    array(
		        'label'=>  __('Set Heading Title', 'rehub-framework'),
		        'id'    => 'brand_heading',
		        'type'  => 'text'
		    ),    
		    array(
		        'label'=>  __('Set Short description', 'rehub-framework'),
		        'desc'  => __('Will be in sidebar', 'rehub-framework'),
		        'id'    => 'brand_short_description',
		        'type'  => 'textarea'
		    ),    
		    array(
		        'label'=>  __('Set url of store', 'rehub-framework'),
		        'id'    => 'brand_url',
		        'type'  => 'text'
		    ),
		    array(
		        'label'=>  __('Set short notice (cashback notice)', 'rehub-framework'),
		        'id'    => 'cashback_notice',
		        'type'  => 'text'
		    ),    
		    array(
		        'label'=>  __('Set bottom description', 'rehub-framework'),
		        'desc'  => __('Will be in bottom of page', 'rehub-framework'),
		        'id'    => 'brand_second_description',
		        'type'  => 'textarea'
		    ),             
		    array(
		        'label'  => __('Upload logo', 'rehub-framework'),
		        'desc'  => __('Upload or choose image here for retailer logo or category header banner', 'rehub-framework'),
		        'id'    => 'brandimage',
		        'type'  => 'image'
		    ),      
		));
	...
	public function add_meta_boxes() {
		...
		add_meta_box( 'rehub-post-images', __( "Post Thumbnails and video", "rehub-framework"  ), array( $this, 'gallery_output' ), $def_p_types, 'side', 'low' );
		add_meta_box( 'post_rehub_offers', __( "Post Offer", "rehub-framework"  ), array( $this, 'show_post_metabox' ), $def_p_types, 'normal', 'low' );
		add_meta_box( 'rh_review_section', __( "Review Data", "rehub-framework" ), 'rh_review_inner_custom_box', 'comment', 'normal' );		
		
		if(class_exists('WooCommerce')){
			add_meta_box( 'rh-wc-product-video', __( "Product video", "rehub-framework" ), array($this, 'wc_video_output'), 'product', 'side', 'low' );
			add_meta_box( 'side_rh_woo', __( "Product Layout", "rehub-framework" ), array($this, 'wc_side_output'), 'product', 'side', 'high' );			
		}	

		add_meta_box( 'rh-shortcode-elementor-box', __( "Shortcode", "rehub-framework" ), array($this, 'rhe_shortcode_box'), 'elementor_library', 'side', 'high' );
	}
	    ...
	    foreach ($variablearray as $field) {
	        ...
	        echo '<tr>
	                ...
	                switch($field['type']) {
						...
						break;
	                    case 'helper':
	                        _e('By default, only next Post layouts will show offerbox automatically: Compact, Button in corner, Big post offer block in top, Offer and review score. You can also add next shortcode to render offerbox:', 'rehub-framework');
	                        echo '<br><br>';                    
	...
	public static function gallery_output( $post ) {
					...
					if ( ! empty( $attachments ) ) {
						foreach ( $attachments as $attachment_id ) {
							...
							echo '<li class="image" data-attachment_id="' . esc_attr( $attachment_id ) . '">
								' . $attachment . '
								<ul class="actions">
									<li><a href="#" class="delete tips" data-tip="' . esc_attr__( "Delete image", "rehub-framework" ) . '">' . __( "Delete", "rehub-framework" ) . '</a></li>
								</ul>
							</li>';
		...
		<p class="rh_add_post_images hide-if-no-js">
			<a href="#" data-choose="<?php esc_attr_e( "Add Images to Post Gallery", "rehub-framework" ); ?>" data-update="<?php esc_attr_e( "Add to gallery", "rehub-framework" ); ?>" data-delete="<?php esc_attr_e( "Delete image", "rehub-framework" ); ?>" data-text="<?php esc_attr_e( "Delete", "rehub-framework" ); ?>"><?php _e( "Add post gallery images", "rehub-framework" ); ?></a>
		</p>
		
		<p class="rh_add_post_images hide-if-no-js">
		<small><?php _e('Add video links, each link from new line. Youtube and vimeo are supported', 'rehub-framework');?></small>
	...
	public static function wc_video_output( $post ){
		...
		<div id="product_video_container" class="hide-if-no-js">
			...
			<p class="howto"><?php _e('Add video links, each link from new line. Youtube and vimeo are supported', 'rehub-framework'); ?></p>
		</div>
		<?php
	}
	...
	public function wc_side_output($post){
		...
		echo '<select name="_rh_woo_product_layout" id="_rh_woo_product_layout" style="width:100%; margin: 10px 0">'; 
			$product_layouts = apply_filters( 'rehub_product_layout_array', array(
				'global' => __('Global from Theme option - Shop', 'rehub-framework'),
				'default_sidebar' => __('Default with sidebar', 'rehub-framework'), 
				'default_no_sidebar' => __('Default full width', 'rehub-framework'),
				'full_width_extended' => __('Full width Extended', 'rehub-framework'),
				'full_width_advanced' => __('Full width Advanced', 'rehub-framework'),
				'sections_w_sidebar' => __('Sections with sidebar', 'rehub-framework'),
				'ce_woo_list' => __('Content Egg List', 'rehub-framework'),
				'ce_woo_sections' => __('Content Egg Auto Sections', 'rehub-framework'),
				'ce_woo_blocks' => __('Review with Blocks', 'rehub-framework'),			
				'vendor_woo_list' => __('Compare Prices with shortcode', 'rehub-framework'),
				'compare_woo_list' => __('Compare Prices by sku', 'rehub-framework'),			
				'full_photo_booking' => __('Full width Photo', 'rehub-framework'),
				'woo_compact' => __('Compact Style', 'rehub-framework'),
				'woo_directory' => __('Directory Style', 'rehub-framework'),							
				)
			);
		...
		$badges = apply_filters( 'rehub_product_badges', array(
			'no' => __('No Badge', 'rehub-framework'),		
			'1' => (REHub_Framework::get_option('badge_label_1') !='') ? REHub_Framework::get_option('badge_label_1') : __('Editor choice', 'rehub-framework'),
			'2' => (REHub_Framework::get_option('badge_label_2') !='') ? REHub_Framework::get_option('badge_label_2') : __('Best seller', 'rehub-framework'), 
			'3' => (REHub_Framework::get_option('badge_label_3') !='') ? REHub_Framework::get_option('badge_label_3') : __('Best value', 'rehub-framework'),
			'4' => (REHub_Framework::get_option('badge_label_4') !='') ? REHub_Framework::get_option('badge_label_4') : __('Best price', 'rehub-framework'),						
			)
		);
	            ...
	            <td>    
	                ...
	                <?php elseif($field['type'] == 'image'):?>
	                    ...
	                    <div class="wpsm_tax_helper_image">
	                        ...
	                        <a href="#" class="wpsm_tax_helper_upload_image_button button" rel=""><?php _e('Choose Image', 'rehub-framework'); ?></a>
	...
	function rhe_shortcode_box($post){
	    ?>
	    <h4 style="margin-bottom:5px;"><?php _e('Shortcode', 'rehub-framework');?></h4>
	    <input type='text' class='widefat' value='[RH_ELEMENTOR id="<?php echo $post->ID; ?>"]' readonly="">
	    <h4 style="margin-bottom:5px;"><?php _e('Shortcode with caching (24 hours)', 'rehub-framework');?></h4>
	    <input type='text' class='widefat' value='[RH_ELEMENTOR id="<?php echo $post->ID; ?>" cache=1 expire=24]' readonly="">
	    <h4 style="margin-bottom:5px;"><?php _e('Ajax loaded on Hover and trigger classes', 'rehub-framework');?></h4>
	    ...
	    <h4 style="margin-bottom:5px;"><?php _e('Php code', 'rehub-framework');?></h4>
	...
	public function rh_custom_code_data_tab($product_data_tabs){
	    $product_data_tabs['rh-custom-code-tab'] = array(
	        'label' => __( 'Custom code areas', 'woocommerce' ),
	...
	public function rh_custom_code_data_fields() {
	    ...
	    class = 'panel woocommerce_options_panel' > <?php
	        ?> <div class = 'options_group' > <?php
			    woocommerce_wp_textarea_input( array( 'id' => 'rh_code_incart', 'class' => 'short', 'label' => __( 'Custom shortcode', 'rehub-framework' ), 'description' => __( 'Will be rendered near button', 'rehub-framework' )  ));
			    woocommerce_wp_textarea_input( array( 'id' => 'rehub_woodeals_short', 'class' => 'short', 'label' => __( 'Custom shortcode', 'rehub-framework' ), 'description' => __( 'Will be rendered before Content', 'rehub-framework' )  ));
			    woocommerce_wp_textarea_input( array( 'id' => 'woo_code_zone_footer', 'class' => 'short', 'label' => __( 'Custom shortcode', 'rehub-framework' ), 'description' => __( 'Will be rendered as Additional Section', 'rehub-framework' )  )); 
	        ?> </div>
