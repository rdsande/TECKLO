...
<?php
    /* Template Name: Top table constructor (outdated)*/
?>
<?php 
    ...
    $first_column_name = (vp_metabox('rehub_top_table.first_column_name') !='') ? esc_html(vp_metabox('rehub_top_table.first_column_name')) : __('Product', 'rehub-theme') ;
