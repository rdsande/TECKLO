...
function rehub_register_sidebars() {
	...
	register_sidebar(array(
		'id' => 'rhsidebar',
		'name' => __('Sidebar Area', 'rehub-theme'),
	...
	register_sidebar(array(
		'id' => 'footercustom',
		'name' => __('Bottom Custom Footer Area', 'rehub-theme'),
	...
	register_sidebar(array(
		'id' => 'rhcustomsidebar',
		'name' => __('Custom sidebar area', 'rehub-theme'),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<div class="title">',
		'after_title' => '</div>',
	...
	register_sidebar(array(
		...
		'name' => __('Custom sidebar area 2', 'rehub-theme'),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<div class="title">',
		'after_title' => '</div>',
	...
	if(rehub_option('enable_brand_taxonomy') == 1 || REHUB_NAME_ACTIVE_THEME == 'RECASH'){
		register_sidebar(array(
			...
			'name' => __('Affiliate store archive sidebar', 'rehub-theme'),
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget' => '</div>',
			'before_title' => '<div class="title">',
			'after_title' => '</div>',
	...
	if(function_exists('bp_is_active') ){
		register_sidebar(array(
			...
			'name' => __('Buddypress Profile sidebar', 'rehub-theme'),
	...
	if(rehub_option('bp_group_widget_area') == 1 ){
		register_sidebar(array(
			...
			'name' => __('Buddypress Group sidebar', 'rehub-theme'),
			'before_widget' => '<div id="%1$s" class="rh-cartbox widget %2$s">',
			'after_widget' => '</div>',
			'before_title' => '<div class="widget-inner-title rehub-main-font">',
			'after_title' => '</div>',
	...
	if (class_exists('Woocommerce')) {
		register_sidebar(array(
			'id' => 'woostore-sidebar',
			'name' => __('Woo brand archive sidebar', 'rehub-theme'),
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget' => '</div>',
			'before_title' => '<div class="title">',
			'after_title' => '</div>',
		...
		register_sidebar(array(
			'id' => 'wooshopsidebar',
			'name' => __('Woocommerce shop sidebar', 'rehub-theme'),
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget' => '</div>',
			'before_title' => '<div class="title">',
			'after_title' => '</div>',
		...
		register_sidebar(array(
			'id' => 'sidebarwooinner',
			'name' => __('Woocommerce product sidebar', 'rehub-theme'),
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget' => '</div>',
			'before_title' => '<div class="title">',
			'after_title' => '</div>',
			...
			<div class="deal_block_row">
	            ...
	            <div class="rh-deal-details">
					...
					<?php if(!empty($offer_coupon)) : ?>
						<div class="redemptionText"><?php _e('Use Coupon Code:', 'rehub-theme');?><span class="code"><?php echo esc_html($offer_coupon); ?></span></div>	
				  	<?php endif;?>
								...
								<?php if($offer_post_url):?>
									<div class="rh-deal-btn">
					                    <a href="<?php echo esc_url ($offer_url) ?>" class="re_track_btn rh-deal-compact-btn btn_offer_block" target="_blank" rel="nofollow">
					                        ...
					                        <?php else :?>
					                            <?php _e('Buy this item', 'rehub-theme') ?>
					                        <?php endif ;?>
					                    </a>		            					
									</div>
								<?php endif;?>
						...
						<div class="rh-deal-right">						
							<?php if(!empty($offer_coupon)) : ?>
								<div class="redemptionText text-right-align">
									<span class="redemptionTextLabel"><?php _e('Use Coupon:', 'rehub-theme');?></span>
