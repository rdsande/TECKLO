	...
	<div class="rate_bar_wrap only_user_reviews<?php if (rehub_option('color_type_review') == 'multicolor') {echo ' colored_rate_bar';} ?>">	
		...
		<div class="total-score-users-head">				
			<div class="review-top">		
				...
				<div class="overall-votes"><span><?php echo ''.$user_rates['criteria'][0]['count'] ;?></span> <?php _e('reviews', 'rehub-theme'); ?></div>	
				<a href="#respond" class="rehub_scroll add_user_review_link"><?php _e("Add your review", "rehub-theme"); ?></a>					
			</div>
		</div>	
