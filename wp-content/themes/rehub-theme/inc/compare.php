...
function rehub_compare_script(){
	...
	$trans_array = array( 
		'item_error_add' => __( 'Please, add items to this compare group or choose not empty group', 'rehub-theme' ), 
		'item_error_comp' => __( 'Please, add more items to compare', 'rehub-theme' )
	);
		...
		<div id="re-compare-bar" class="from-right">
			<div id="re-compare-bar-wrap">
				<div id="re-compare-bar-heading">
					<h5 class="rehub-main-color"><?php _e('Compare items', 'rehub-theme');?><i class="fal fa-times-circle closecomparepanel floatright" aria-hidden="true"></i></h5>
				</div>
				<div id="re-compare-bar-tabs">
					...
					<?php else : ?>
						<ul class="rhhidden"><li class="re-compare-tab-<?php echo ''.$compare_page; ?> no-multicats" data-page="<?php echo ''.$compare_page; ?>" data-url="<?php echo esc_url(get_the_permalink($compare_page)); ?>"><?php _e('Total', 'rehub-theme');?> (<span>0</span>)</li></ul>
						<div><div class="re-compare-wrap re-compare-wrap-<?php echo ''.$compare_page; ?>"></div></div>
					<?php endif; ?>
					<span class="re-compare-destin wpsm-button rehub_main_btn" data-compareurl=""><?php _e('Compare', 'rehub-theme');?><i class="far fa-arrow-circle-right" aria-hidden="true"></i></span>
				</div>
			</div>
		</div>
