                    ...
                    <?php if (defined('\ContentEgg\PLUGIN_PATH')):?>
                        ...
                        <div class="floatright pl20">
                            ...
                            <?php if($amazonupdate && $product_update):?>
                                <div class="font60 lineheight20"><?php _e('Last price update was:', 'rehub-theme');?> <?php echo ''.$product_update;?> <span class="csspopuptrigger" data-popup="ceblocks-amazon-disclaimer"><i class="far fa-question-circle greycolor font90"></i></span></div>
                                <div class="csspopup" id="ceblocks-amazon-disclaimer">
                                    <div class="csspopupinner">
                                        <span class="cpopupclose">×</span>
                                        <?php _e('Product prices and availability are accurate as of the date/time indicated and are subject to change. Any price and availability information displayed on Amazon at the time of purchase will apply to the purchase of this product.', 'rehub-theme');?>
                                    </div>
                                </div>
                            <?php endif;?>                        
                        </div>
                                            ...
                                            <?php if(!empty($itemsync)):?>
                                                ...
                                                <?php 
                                                    ...
                                                    elseif(rehub_option('buy_best_text') !=''){
                                                        ...
                                                        $buy_best_text = __('Buy for best price', 'rehub-theme'); 
                                                    } 
                                                ?>                                                 
                                                <a href="<?php echo esc_url($afflink);?>" class="re_track_btn wpsm-button rehub_main_btn btn_offer_block" target="_blank" rel="nofollow"><?php echo esc_html($buy_best_text);?>
                                                </a> 
                                            <?php else:?>
                                    ...
                                    <?php 
                                        ...
                                        if(!empty($syncitem)) {
                                            ...
                                            $tabs['woo-ce-pricehistory'] = array(
                                                'title' => __('Price History', 'rehub-theme'),
                                                'priority' => '9',
                                        ...
                                        if(!empty($googlenews)){
                                            $tabs['woo-ce-news'] = array(
                                                'title' => __('World News', 'rehub-theme'),
                                                'priority' => '23',
