            ...
            <div class="rh-flex-center-align rh-flex-justify-center pt15 pb15 mobileblockdisplay">
                ...
                <div class="rh-flex-grow1 listitem_title listitem_column">
                    ...
                    <?php if (!empty($item['extra']['conditionDisplayName'])): ?>
                        ...
                        <?php _e('Condition: ', 'rehub-theme') ;?><span class="yes_available"><?php echo ''.$item['extra']['conditionDisplayName'] ;?></span>
                        <br />
                        </small>
                    <?php endif; ?>
                    ...
                    <?php if($module_id == 'Amazon'):?>
                        <div class="font80 rh_opacity_7">
                            <?php _e('Last update was on: ', 'rehub-theme'); ?><?php echo TemplateHelper::getLastUpdateFormatted('Amazon', $post_id); ?>
                        </div> 
                    <?php endif; ?>
                    <?php if ($stock_status_str): ?>
                        <div title="<?php _e('Last update was on: ', 'rehub-theme'); ?><?php echo TemplateHelper::getLastUpdateFormatted($item['module_id'], $post_id); ?>" class="cegg-lineheight15 blockstyle font80 stock-status status-<?php echo esc_attr($stock_status_class);?>">
