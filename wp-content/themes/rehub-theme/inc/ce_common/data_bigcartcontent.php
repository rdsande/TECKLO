    ...
    <div class="product_egg single_product_egg">
        ...
        <div class="image col_item">
            ...
            <?php if (!empty($item['extra']['itemLinks'][3])): ?>
                <span class="add_wishlist_ce">
                    <a href="<?php echo esc_url($item['extra']['itemLinks'][3]['URL']);?>" rel="nofollow" target="_blank" ><i class="far fa-heart"></i> <?php echo esc_attr($item['extra']['itemLinks'][3]['Description']);?></a>
                </span>
            <?php endif; ?>                           
        </div>
        ...
        <div class="product-summary col_item">
            ...
            <?php if($offer_price) : ?>
                <div class="deal-box-price">
                    ...
                    <?php if ($stock_status_str): ?>
                        <mark title="<?php _e('Last update was on: ', 'rehub-theme'); ?><?php echo TemplateHelper::getLastUpdateFormatted($item['module_id'], $post_id); ?>" class="rh-stock-status status-<?php echo esc_attr($stock_status_class);?>">
                ...
                <small class="small_size">  
                    <?php if ($time_left): ?>
                        <span class="time_left_ce yes_available">
                            <i class="far fa-clock"></i> <?php _e('Time left:', 'rehub-theme'); ?>
                    ...
                    <?php if (!empty($item['extra']['conditionDisplayName'])): ?>
                        <?php _e('Condition: ', 'rehub-theme') ;?><span><?php echo ''.$item['extra']['conditionDisplayName'] ;?></span>
                        <br />
                    <?php endif; ?>                        
                </small>
            <?php endif; ?>
            ...
            <?php if (!empty($item['extra']['IsEligibleForSuperSaverShipping'])): ?>
                <small class="small_size"><span class="yes_available"><?php _e('Free shipping', 'rehub-theme'); ?></span></small><br>
            <?php endif; ?> 
            ...
            <div class="font80 rh_opacity_7 mb15"><?php _e('Last update was on: ', 'rehub-theme'); ?><?php echo TemplateHelper::getLastUpdateFormatted($module_id, $post_id); ?></div>    
