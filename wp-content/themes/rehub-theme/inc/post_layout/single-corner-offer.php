                            ...
                            <?php if(vp_metabox('rehub_post_side.disable_top_offer') != '1')  : ?>
                                <div class="right_aff">
                                    ...
                                    if (!empty($amazon_search_words)) {
                                        $rehub_amazon_btn = (rehub_option('rehub_amazon_btn') !='') ? rehub_option('rehub_amazon_btn') : __('Search on Amazon', 'rehub-theme');
                                    ...
                                    if (!empty($ebay_search_words)) {
                                        $rehub_ebay_btn = (rehub_option('rehub_ebay_btn') !='') ? rehub_option('rehub_ebay_btn') : __('Search on Ebay', 'rehub-theme');
