                ...
                <div class="rh-post-wrapper">             
                    <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
                        ...
                        <article <?php post_class($postclasses); ?> id="post-<?php the_ID(); ?>">
                                <div class="rh_post_layout_compare_autocontent">
                                    ...
                                    <div class="wpsm-two-third wpsm-column-last">
                                        ...
                                        <div class="rh_post_layout_rev_price_holder">
                                            <div class="rh_price_holder_add_links">
                                                <?php if (vp_metabox('rehub_post.rehub_framework_post_type') == 'review' && rehub_option('type_user_review') == 'full_review' && comments_open()) :?>
                                                    <a href="#respond" class="rehub_scroll add_user_review_link"><?php _e("Add your review", "rehub-theme"); ?> 
                                                    </a>
                                                <?php endif;?>
                                            </div>                                
                                            ...
                                            <div class="compare-button-holder">
                                                ...
                                                <?php if ($offer_url):?>
                                                    ...
                                                    <?php $buy_best_text = (rehub_option('buy_best_text') !='') ? esc_html(rehub_option('buy_best_text')) : __('Buy for best price', 'rehub-theme'); ?>                        
                                                    <a href="<?php echo esc_url($offer_url);?>" class="re_track_btn wpsm-button rehub_main_btn btn_offer_block" target="_blank" rel="nofollow"><?php echo esc_attr($buy_best_text);?></a>                        
                                                <?php endif;?>                
                                            </div>
                                        ...
                                        <?php if(rehub_option('rehub_disable_share_top') =='1' || vp_metabox('rehub_post_side.disable_parts') == '1')  : ?>
                                            <?php 
                                                $wishlistadd = __('Save', 'rehub-theme');
                                                $wishlistadded = __('Saved', 'rehub-theme');
                                                $wishlistremoved = __('Removed', 'rehub-theme');
                                            ?>      
                                ...
                                <div class="rh-tabletext-block-heading no-border"><span class="toggle-this-table"></span><h4><?php _e('Price list', 'rehub-theme');?></h4></div>
                                ...
                                <?php if( $flipkart_specification):?>
                                    ...
                                    <div class="rh-tabletext-block-heading"><span class="toggle-this-table"></span><h4><?php _e('Specification', 'rehub-theme');?></h4></div>  
                                ...
                                <?php if(!empty($youtube_key)):?>
                                    <div class="rh-tabletext-block">
                                    <div class="rh-tabletext-block-heading"><span class="toggle-this-table"></span><h4><?php _e('Video', 'rehub-theme');?></h4></div>  
                                    <div class="rh-tabletext-block-wrapper">                          
                                ...
                                <?php if(!empty($googlebook_key)):?>
                                    <div class="rh-tabletext-block">
                                    <div class="rh-tabletext-block-heading"><span class="toggle-this-table"></span><h4><?php _e('Manuals', 'rehub-theme');?></h4></div>  
                                    <div class="rh-tabletext-block-wrapper">                          
                                ...
                                <?php if(!empty($googlenews)):?>
                                    <div class="rh-tabletext-block">
                                    <div class="rh-tabletext-block-heading"><span class="toggle-this-table"></span><h4><?php _e('World News', 'rehub-theme');?></h4></div>  
                                    <div class="rh-tabletext-block-wrapper">                          
                                ...
                                <?php if($feedback_true):?>
                                    <div class="rh-tabletext-block">
                                    <div class="rh-tabletext-block-heading"><span class="toggle-this-table"></span><h4><?php _e('Feedbacks', 'rehub-theme');?></h4></div>  
                                    <div class="rh-tabletext-block-wrapper">                          
                                        <?php if ($amazon_rev):?>
                                ...
                                <div class="rh-tabletext-block">
                                <div class="rh-tabletext-block-heading"><span class="toggle-this-table"></span><h4><?php _e('Description and Review', 'rehub-theme');?></h4></div>  
                                <div class="rh-tabletext-block-wrapper">                          
                                    <?php the_content(); ?>
                                </div>                               
                                </div> 
