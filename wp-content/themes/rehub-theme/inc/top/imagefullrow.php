...
<div class="product_image_col<?php echo ''.$sticky_header; ?>">
    ...
    <div class="price-in-compare-flip mt20">
        ...
        <?php else:?>
            ...
            <?php if($price_from) :?>
                <?php _e('Prices start from:', 'rehub-theme');?> <span class="greencolor"><?php echo ''.$price_from;?></span>
                <a href="<?php echo get_the_permalink(get_the_ID());?>" class="btn_offer_block mt15 rh-deal-compact-btn"><?php _e('Check all prices', 'rehub-theme');?></a>
            <?php endif;?>                   
        <?php endif;?>                                               
    </div>                                              
</div>