...
<?php if($rating_score_clean):?>
    ...
    <?php elseif ($rating_circle =='2') :?> 
        <div class="rehub_rating_row"><span style="width:<?php echo ''.$rating_score_clean * 10 ;?>%"></span></div>  
    <?php elseif ($rating_circle =='0') :?> 
        <div class="score"> <span class="it_score"><?php echo ''.$rating_score_clean ?></span></div>          
    <?php else :?>
        <div class="rehub_rating_row"><span style="width:<?php echo ''.$rating_score_clean * 10 ;?>%"></span></div>  
    <?php endif ;?>
    <a href="<?php the_permalink();?>" class="read_full" target="_blank"><?php if(rehub_option('rehub_review_text') !='') :?><?php echo rehub_option('rehub_review_text') ; ?><?php else :?><?php _e('Read review', 'rehub-theme'); ?><?php endif ;?></a>
    </div>
<?php endif ;?>