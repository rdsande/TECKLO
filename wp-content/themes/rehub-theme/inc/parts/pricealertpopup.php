...
<?php if(defined('\ContentEgg\PLUGIN_PATH')):?>
    <?php if (ContentEgg\application\helpers\TemplateHelper::isPriceAlertAllowed($unique_id, $module_id)): ?>
        ...
        <div class="pricealertpopup-wrap flowhidden">
            <span class="csspopuptrigger floatright mb10 greencolor" data-popup="pricealert_<?php echo ''.$rand;?>"><i class="far fa-bell mr5" aria-hidden="true"></i> <?php _e('Set Lowest Price Alert', 'rehub-theme');?></span>
            <div class="csspopup" id="pricealert_<?php echo ''.$rand;?>">
                <div class="csspopupinner cegg-price-alert-popup">
                    <span class="cpopupclose">×</span>            
                    <div class="cegg-price-alert-wrap">                       
                        <div class="re_title_inmodal"><i class="far fa-bell" aria-hidden="true"></i> <?php _e('Notify me, when price drops', 'rehub-theme'); ?></div>
                        <div class="rh-line mb20"></div>
                        <div class="mb20 font90">
                            <?php _e('Set Alert for Product', 'rehub-theme'); ?>: <?php echo ''.$syncitem['title'];?> - <?php echo ContentEgg\application\helpers\TemplateHelper::formatPriceCurrency($syncitem['price'], $syncitem['currencyCode']); ?>
                        </div>                     
                        <form>
                            ...
                            <div class="re-form-group mb20">                               
                                <label><?php _e('Your Email', 'rehub-theme'); ?>:</label>
                                <input type="email" name="email" class="re-form-input">
                            </div>
                            <div class="re-form-group mb20">
                                <label><?php _e('Desired price', 'rehub-theme'); ?>:</label> 
                                <input type="text" name="price" class="re-form-input">
                            </div>
                            <input value="<?php _e('Start tracking', 'rehub-theme'); ?>" type="submit" class="wpsm-button rehub_main_btn" /> 
