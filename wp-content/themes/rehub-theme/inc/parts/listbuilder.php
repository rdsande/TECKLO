        ...
        <?php if(isset($image) && $image):?>
            <div class="listbuild_image listitem_column text-center">
                ...
                <?php if($togglelink == 'image'):?>
                    <span class="rehub-main-color fontnormal r_show_hide mt15 ml5 font80"><?php esc_html_e('More details +', 'rehub-theme');?></span>
                <?php endif;?>                             
            </div>
        <?php endif;?>
        ...
        <?php if(!empty($section) && isset($section[0]['sectiontype']) && $section[0]['sectiontype'] != 'empty'):?>
            <div class="rh-flex-center-align rh-flex-justify-center rh-flex-grow1 listitem_content_meta">
                <?php foreach ($section as $item):?>
                    <div class="rh-flex-grow1 text-center elementor-repeater-item-<?php echo esc_attr($item['_id']);?>">
                        ...
                        <?php if ($tooltip) :?>
                            <span class="wpsm_spec_meta_tooltip lineheight20 blockstyle"><?php echo wpsm_shortcode_tooltip(array('text' => '<i class="far fa-question-circle greycolor font80"></i>'), $tooltip);?></span>
                        <?php endif;?>                                               
                    </div> 
                <?php endforeach;?>
            </div>
            ...
            <div class="listbuild_btn listitem_column text-center">
                <?php if(get_post_type($postid) == 'product'):?>
                    ...
                    <?php if ($product->get_price() !='') : ?>
                        <span class="rehub-main-font price font110 mb15 fontbold"><?php echo ''.$product->get_price_html(); ?></span>
                        <div class="mb10"></div>
                    <?php endif;?>                    
    ...
    <?php if($togglelink !='no'):?>
        <div class="open_dls_onclk flowhidden border-top pr25 pl25">
            ...
            <?php if($togglecontent=='review'):?>
                <?php $summary = rehub_exerpt_function(array('reviewtext'=> '1', 'length'=> 1000));?>
