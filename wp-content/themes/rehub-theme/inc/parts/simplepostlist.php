...
<div class="col_item flowhidden item-small-news<?php if($image):?> item-small-news-image<?php endif;?><?php if($border):?> border-lightgrey pb10 pl10 pr10 pt10 mb20<?php endif;?>">
	<?php if($image):?>
		<figure class="<?php if($border):?>img-centered-flex rh-flex-center-align rh-flex-justify-center<?php else:?>text-center<?php endif;?>"><a href="<?php the_permalink();?>"><?php WPSM_image_resizer::show_static_resized_image(array('thumb'=> true, 'crop'=> false, 'height'=> 80, 'no_thumb_url' => get_template_directory_uri() . '/images/default/noimage_100_70.png'));?></a></figure>
	<?php endif;?>
