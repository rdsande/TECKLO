...
<div class="rehub_bordered_block rh_listofferitem rh_list_mbl_im_left <?php echo ''.$reveal_enabled; echo ''.$coupon_style; ?><?php echo ''.($disclaimer) ? ' mb0' : '';?>">
    <div class="rh-flex-center-align rh-flex-justify-center mobileblockdisplay">
            ...
            <a href="<?php echo esc_url($offer_url) ?>" target="_blank" rel="nofollow" class="re_track_btn">
        ...
        <div class="text-right-align rh_listcolumn_btn">
            ...
            <?php else :?>
                <?php if(!empty($offer_coupon)) : ?>
                    <?php wp_enqueue_script('zeroclipboard'); ?>
                    <div class="mt10 rehub_offer_coupon not_masked_coupon <?php if(!empty($offer_coupon_date)) {echo ''.$coupon_style ;} ?>" data-clipboard-text="<?php echo esc_html($offer_coupon); ?>"><i class="fal fa-cut fa-rotate-180"></i><span class="coupon_text"><?php echo esc_html($offer_coupon); ?></span>
                    </div>
                <?php endif;?>
            <?php endif;?>                  
