...
<form action="/" method="get" id="form" name="form" accept-charset="utf-8">
    <p><label><?php _e('Search products', 'rehub-theme') ;?></label>
        <input type="text" name="woolist-ids" value="" id="woolist-ids" /><br />
		<small></small>
    </p> 
    <p><label><?php _e('Or search product tags', 'rehub-theme') ;?></label>
        <input type="text" name="woolist-tag" value="" id="woolist-tag" /><br />
        <small></small>
    </p>
    <p><label><?php _e('Numbers of posts to show', 'rehub-theme') ;?></label>
        <input type="text" name="woolist-show" value="" id="woolist-show" /><br />
        <small><?php _e('Set number', 'rehub-theme') ;?></small>
    </p>	 <p>
        <label>&nbsp;</label>
