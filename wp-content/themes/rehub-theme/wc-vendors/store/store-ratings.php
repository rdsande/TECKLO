...
<div class="wcvendor_store_wrap_bg">
	...
	<div id="wcvendor_profile_menu">
		<div class="rh-container">			
			...
			<li><a href="<?php echo esc_url($vendor_shop_url);?>"><?php _e('Return to store', 'rehub-theme');?></a></li>
			<li class="active"><a href="#"><?php _e('Reviews', 'rehub-theme');?></a></li>	
			</ul>
    ...
    <div class="rh-content-wrap clearfix">
        ...
        <div class="main-side woocommerce page clearfix full_width">
            <article class="post" id="page-<?php the_ID(); ?>">
            	...
            	<h3 class="page-title mt0"><?php _e( 'Customer Ratings', 'rehub-theme' ); ?></h3>
				...
				<?php if ( $vendor_feedback ) { 
					...
					foreach ( $vendor_feedback as $vf ) {
						...
						<div class="wcv-rating-posted-by">
							<span><?php __( 'Posted on', 'rehub-theme'); ?> <?php echo ''.$post_date; ?></span> <?php __( 'by', 'rehub-theme'); echo ''.$customer_name; ?>
							<p><?php _e( 'Product:', 'rehub-theme'); ?><a href="<?php echo esc_url($product_link); ?>" target="_blank"><?php echo ''.$product_title; ?></a></p>
						</div>
				...
				} else {  echo __( 'No ratings have been submitted for this vendor yet.', 'rehub-theme' ); }  ?> 
				
				<a href="<?php echo esc_url($vendor_shop_url); ?>"><?php _e( 'Return to store', 'rehub-theme' ); ?></a>           	
