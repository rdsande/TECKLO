...
$best_price_text = (rehub_option('rehub_btn_text_best') !='') ? esc_html(rehub_option('rehub_btn_text_best')) : __('Best price', 'rehub-theme');
    ...
    <div class="product_egg_extra">
        ...
        <div class="product-summary col_item"> 
            ...
            <?php else :?> 
                ...
                <?php if(!empty($offer_url_first)) : ?> 
                    <div class="priced_block">
                        <div>
                            <a class="re_track_btn btn_offer_block" href="<?php echo esc_url($offer_url_first) ?>"<?php echo ''.$items[0]['ga_event'] ?> target="_blank" rel="nofollow">
                                <?php esc_html_e('Best price', 'rehub-theme'); ?>
                            </a>
            ...
            <?php if (!empty($offer_desc_first)): ?>
                ...
                <p><a class="rehub-main-color read_more_aff" href="<?php echo esc_url($offer_url_first) ?>"<?php echo ''.$items[0]['ga_event'] ?> target="_blank" rel="nofollow"><?php esc_html_e('Read more on shop website ', 'rehub-theme'); ?>&#8594;</a></p>                  
            <?php endif; ?>             
        </div>           
    </div> 
</div>  
...
<div class="rehub_woo_review">
        ...
        <ul class="rehub_woo_tabs_menu">
            ...
            <?php if (!empty ($attributes)) :?><li class="affspec"><?php esc_html_e('Specification', 'rehub-theme') ?></li><?php endif ;?>
                    ...
                    <div class="rh-flex-center-align rh-flex-justify-center pt15 pb15 mobileblockdisplay">
                        ...
                        <div class="rh_listcolumn rh-flex-grow1 rh_listcolumn_text">
                            <div class="simple_title mb15">
                                <a rel="nofollow" target="_blank" class="re_track_btn font100 no-color-link blockstyle rehub-main-font lineheight20" href="<?php echo esc_url($afflink) ?>"<?php echo ''.$item['ga_event'] ?>>
