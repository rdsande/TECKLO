        ...
        <div class="product_egg single_product_egg">
            ...
            <div class="product-summary col_item">
	            ...
	            <?php if ($offer_desc): ?>
	                ...
	                <small class="small_size"><?php if ($item['manufacturer']): ?><?php esc_html_e('Made by: ', 'rehub-theme') ;?><?php echo esc_html($item['manufacturer']); ?>, <?php endif; ?><?php if ($item['in_stock']): ?><?php esc_html_e('Available: ', 'rehub-theme') ;?><span class="yes_available"><?php esc_html_e('In stock', 'rehub-theme') ;?></span><?php endif; ?></small>
	            <?php endif; ?>	            
