				...
				<?php if ( ! bp_disable_group_avatar_uploads() ) : ?>
					<div class="item-avatar">
						...
						<?php global $groups_template;
								$count = $groups_template->group->total_member_count; ?>
						<span class="member-count"><?php echo (int)$count; ?></span>
					</div>
				<?php endif; ?>

				<div class="item">
					<div class="item-title"><a href="<?php bp_group_permalink(); ?>"><?php bp_group_name(); ?></a></div>
					<div class="item-meta"><span class="activity"><?php printf( __( 'active %s', 'rehub-theme' ), bp_get_group_last_active() ); ?></span></div>
...
<?php else: ?>
	...
	<div id="message" class="info">
		<p><?php _e( 'There were no groups found.', 'rehub-theme' ); ?></p>
	</div>
