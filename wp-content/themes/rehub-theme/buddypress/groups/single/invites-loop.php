...
<div class="main-column">
			...
			<?php while ( bp_group_invites() ) : bp_group_the_invite(); ?>
				...
				<li id="<?php bp_group_invite_item_id(); ?>" class="col_item">
					<div class="friend-inner-list">
						...
						<div class="action">
							<a class="button remove" href="<?php bp_group_invite_user_remove_invite_url(); ?>" id="<?php bp_group_invite_item_id(); ?>"><?php _e( 'Remove Invite', 'rehub-theme' ); ?></a>
	...
	<?php else : ?>
		...
		<div id="message" class="info">
			<p><?php _e( 'Select friends to invite.', 'rehub-theme' ); ?></p>
		</div>
