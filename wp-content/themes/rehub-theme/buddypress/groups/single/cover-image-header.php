					...
					<div class="rh-container" id="rhbp-header-profile-cont">		
						...
						<div id="rh-header-bp-content">
							...
							<div id="item-meta">
								...
								<span class="activity"><?php printf( __( 'active %s', 'rehub-theme' ), bp_get_group_last_active() ); ?></span>
                                    ...
                                    <?php if ($desc_len > 180) :?>                           
										<div class="r_offer_details">
											...
											<span class="r_show_hide"><?php _e('(Show full)', 'rehub-theme');?></span>
				...
				<div id="rh-item-admins">
					<?php if ( bp_group_is_visible() ) : ?>
						<div class="group-list-admins">
							<div class="admin-groups"><?php _e( 'Group Admins', 'rehub-theme' ); ?></div>
							<?php 
					...
					<?php if ( bp_group_has_moderators() ) : ?>
						<div class="group-list-admins group-list-mods">
							...
							<div class="admin-groups"><?php _e( 'Group Mods' , 'rehub-theme' ); ?></div>
							<?php 
							bp_group_list_mods();
