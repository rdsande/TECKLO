...
<div id="buddypress">
	...
	<div class="page" id="activate-page">
		...
		<?php if ( bp_account_was_activated() ) : ?>
			...
			<?php if ( isset( $_GET['e'] ) ) : ?>
				<p><?php _e( 'Your account was activated successfully! Your account details have been sent to you in a separate email.', 'rehub-theme' ); ?></p>
			<?php else : ?>
		...
		<?php else : ?>
			...
			<p><?php _e( 'Please provide a valid activation key.', 'rehub-theme' ); ?></p>
			<form action="" method="post" class="standard-form" id="activation-form">
				<label for="key"><?php _e( 'Activation Key:', 'rehub-theme' ); ?></label>
