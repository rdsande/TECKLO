		...
		<div class="rh-mini-sidebar floatleft tabletblockdisplay mb0">
			<?php 
				if(function_exists('mycred_display_users_total_balance')){
			    	...
			    	if(!empty($mycredpoint)){
			    		echo '<div class="rh-bp-mycred-profile-points mb20 rehub-main-color-bg rehub-sec-smooth"><div>';
			    			echo '<div class="rh-bp-mycred-title mb10">'.__('User Balance', 'rehub-theme').'<i class="fal fa-wallet floatright font150"></i></div>';
			    			echo '<div class="rh-bp-mycred-points-pr"><span>'.$mycredpoint.'</span>'.esc_html($mycredlabel).'</div>';
			    		echo '</div></div>';
			    	}					
					$cashpoint = 0;
					if(rehub_option('cashback_points') && bp_is_my_profile()){
			    		...
			    		echo '<div class="rh-bp-mycred-profile-points mb20 rehub-sec-color-bg rehub-sec-smooth"><div>';
			    			echo '<div class="rh-bp-mycred-title mb10">'.__('Cashback Balance', 'rehub-theme').'<i class="fal fa-wallet floatright font150"></i></div>';
			...
			<?php if( $is_vendor ) : ?>
				<div class="rh-cartbox user-profile-div text-center widget rehub-sec-smooth">
					<div class="widget-inner-title rehub-main-font"><?php _e('Owner of shop', 'rehub-theme');?></div>
		            ...
		            <div class="profile-stats">
		                ...
		                <div><i class="far fa-briefcase"></i><?php _e( 'Total products', 'rehub-theme' ); echo ': ' . count_user_posts( $author_ID, $post_type = 'product' ); ?></div>	  	
		            </div>                    						
				</div>
			<?php endif;?>        		
		</div>		
