	...
	<?php else :?>
		<?php if(!empty($offer_coupon)) : ?>
			<?php wp_enqueue_script('zeroclipboard'); ?>
		  		...
		  		<div class="printcoupon">
		  			<div class="printcouponwrap">
			  			<div class="printcouponheader">
			  				...
			  				<div class="expired_print_coupon"><?php if(!empty($offer_coupon_date)):?><?php _e('Use before:', 'rehub-theme');?><?php echo esc_attr($offer_coupon_date) ?><?php endif;?></div>
			  			...
			  			<div class="couponprintend"><?php _e('Get more coupons on:', 'rehub-theme');?><span> <?php echo site_url();?></span></div>	
		  			</div>
		  		</div>
		  	...
		  	<span class="printthecoupon" data-printid="<?php echo ''.$printid;?>"><?php _e('Print coupon', 'rehub-theme');?></span>
	  	<?php endif;?>
	<?php endif;?>
	<?php if($product_url):?>
