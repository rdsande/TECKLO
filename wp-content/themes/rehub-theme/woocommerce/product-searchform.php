...
?>
<?php $search_text = (rehub_option('rehub_search_text')) ? rehub_option('rehub_search_text') : __("Search", "rehub-theme"); ?>
...
<form role="search" method="get" class="search-form product-search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	...
	<?php wc_product_dropdown_categories(array('show_count' => 0, 'parent' => 0, 'show_option_none' => __("All categories", "rehub-theme"), 'class'=> 'rh_woo_drop_cat rhhidden rhniceselect', 'id'=>mt_rand())); ?>
