...
<div <?php post_class( $classes ); ?>>
    ...
    <?php elseif ( $product->is_featured() ) : ?>
        <?php echo apply_filters( 'woocommerce_featured_flash', '<span class="re-ribbon-badge badge_2"><span>' . __( 'Featured!', 'rehub-theme' ) . '</span></span>', $post, $product ); ?>          
    ...
    <h3 class="<?php echo getHotIconclass($post->ID, true); ?>">
        ...
        <?php endif; ?>
        <a href="<?php echo esc_url($woolink);?>"<?php echo ''.$wootarget;?>><?php the_title();?></a></h3>
            ...
            <?php if (rehub_option('woo_btn_disable') != '1'):?> 
                <?php if(!empty($syncitem)):?>
                    ...
                    <?php if ($countoffers > 1) :?>
                        <a class="font90 greencolor" href="<?php the_permalink();?>">+ <?php echo ''.$countoffers - 1; ?> <?php _e('more', 'rehub-theme');?></a>
                    <?php endif;?>
