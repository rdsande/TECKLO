...
class Widget_Wpsm_CEBox extends WPSM_Content_Widget_Base {
    ...
    public function get_title() {
        return __('Content Egg Box', 'rehub-theme');
    }
    ...
    protected function general_fields() {
        ...
        $this->add_control( 'type', [
            ...
            'default'     => 'ceoffer',
            'options'     => [
                'ceoffer'=> __('Post box with CE comparison widget', 'rehub-theme'),
                'cemerchant'=>  __('Content Egg merchants table', 'rehub-theme'),
                'cewidget'=>  __('Content Egg logo widget', 'rehub-theme'),
                'cegrid'=>  __('Content Egg grid', 'rehub-theme'),
                'celist'=>  __('Content Egg list with offer images', 'rehub-theme'),
                'celistlogo'=>  __('Content Egg list with logo images', 'rehub-theme'),
                'cestat'=>  __('Content Egg Price statistic', 'rehub-theme'),
                'cehistory'=>  __('Content Egg price history', 'rehub-theme'),
                'cealert'=>  __('Content Egg price alert', 'rehub-theme'),
            ],
            'label_block' => true,
            'dynamic'     => [
                'active' => true,
