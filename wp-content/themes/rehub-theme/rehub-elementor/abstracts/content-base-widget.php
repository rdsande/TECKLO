...
abstract class WPSM_Content_Widget_Base extends Widget_Base {
    ...
    protected function general_fields() {
        ...
        $this->add_control( 'tax_name', [
            ...
            'description' => __( 'Choose taxonomy', 'rehub-theme' ),
            'label_block'  => true,
            'dynamic' => [ 'active' => true, ],
            'condition'  => [ 'data_source' => 'cpt' ],
        ...
        $this->add_control( 'tax_slug', [
            ...
            'description' => __( 'Choose terms of taxonomy which you enabled in field above', 'rehub-theme' ),
            'condition'  => [ 'data_source' => 'cpt' ],
            'label_block'   => true,
            'dynamic'       => [
                                'active' => true,
        ...
        $this->add_control( 'tax_slug_exclude', [
            ...
            'description' => __( 'Choose which terms of taxonomy which you enabled in field above you want to exclude', 'rehub-theme' ),
            'condition'  => [ 'data_source' => 'cpt' ],
            'label_block'  => true,
            'dynamic' => [
                'active' => true,
    ...
    protected function filters_fields() {
        ...
        $repeater = new \Elementor\Repeater();
            ...
            $repeater->add_control( 'filtertaxkey', [
                'type'      => \Elementor\Controls_Manager::TEXT,
                'label'     => __('Additional Taxonomy slug', 'rehub-theme'),
            ...
            $repeater->add_control( 'filtertaxtermslug', [
                'type'      => \Elementor\Controls_Manager::TEXT,
                'label'     => __('Additional Taxonomy term slug', 'rehub-theme'),
    ...
    public function get_products_title_list() {
        ...
        $query = [
            ...
            "where"  => "WHERE post_type IN ('post', 'product', 'blog')",
    ...
    public function get_rehub_post_cat_list() {
        global $wpdb;
