...
class Widget_Wpsm_Colored_Grid_Loop extends WPSM_Content_Widget_Base {
    ...
    public function get_title() {
        return __('Colored Post grid', 'rehub-theme');
    }
    ...
    protected function control_fields() {
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'texttypography',
                'label' => __( 'Text Typography', 'rehub-theme' ),
        ...
        $this->add_control( 'color1', [
            'label' => __( 'Color for each N + 1', 'rehub-theme' ),
        ...
        $this->add_control( 'color2', [
            'label' => __( 'Color for each N + 2', 'rehub-theme' ),
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
        ...
        $this->add_control( 'color3', [
            'label' => __( 'Color for each N + 3', 'rehub-theme' ),
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
        ...
        $this->add_control( 'color4', [
            'label' => __( 'Color for each N + 4', 'rehub-theme' ),
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
        ...
        $this->add_control( 'color5', [
            'label' => __( 'Color for each N + 5', 'rehub-theme' ),
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
        ...
        $this->add_control( 'color6', [
            'label' => __( 'Color for each N + 6', 'rehub-theme' ),
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
