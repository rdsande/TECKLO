...
class WPSM_TabsEvery_Widget extends Widget_Base {
    ...
    public function get_title() {
        return __('Tabs for everything', 'rehub-theme');
    }
    ...
    protected function general_controls() {
        ...
        $repeater = new \Elementor\Repeater();
            ...
            $repeater->add_control( 'title', [
                'label' => __( 'Tab title', 'rehub-theme' ),
            ...
            $repeater->add_control( 'color', [
                'label' => __( 'Set text color', 'rehub-theme' ),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control( 'TabsEvery', [
            'label'    => __( 'TabsEvery', 'rehub-theme' ),
        ...
        $this->add_control( 'activebgcolor', [
            'label' => __( 'Set background color for active tab', 'rehub-theme' ),
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
        ...
        $this->add_control( 'activecolor', [
            'label' => __( 'Set text color for active tab', 'rehub-theme' ),
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
