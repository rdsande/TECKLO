...
class WPSM_Tax_Archive_Widget extends Widget_Base {
    ...
    public function get_title() {
        return __('Tax Archive', 'rehub-theme');
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control( 'taxonomy', [
            ...
            'description' => __( 'Select taxonomy', 'rehub-theme' ),
            'label_block'  => true,
            'dynamic' => [ 'active' => true, ],
        ...
        $this->add_control( 'child_of', [
            ...
            'description' => __( 'Set ID of parent category if you want to show only child Items', 'rehub-theme' ),
            'conditions'  => [
                'terms'   => [
                    [
                        'name'     => 'taxonomy',
        ...
        $this->add_control( 'include', [
            ...
            'description' => __( 'Set Ids if you want to show only special taxonomies', 'rehub-theme' ),
            'conditions'  => [
                'terms'   => [
                    [
                        'name'     => 'taxonomy',
