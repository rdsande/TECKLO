...
class WPSM_Column_News_Block_Widget extends Widget_Base {
    ...
    public function get_title() {
        return __('Column news block', 'rehub-theme');
    }
    ...
    protected function wpsm_first_columns_fields() {
        ...
        $this->add_control( 'post_formats_first', [
            ...
            'options'     => array(
                'all'       => __('all', 'rehub-theme'),
                'regular'   => __('regular', 'rehub-theme'),
                'video'     => __('video', 'rehub-theme'),
                'gallery'   => __('gallery', 'rehub-theme'),
                'review'    => __('review', 'rehub-theme'),
                'music'     => __('music', 'rehub-theme'),
            )
        ]);
