            ...
            <div class="rh-flex-center-align rh-flex-justify-center pt15 pb15 mobileblockdisplay">
                ...
                <div class="rh_listcolumn rh-flex-grow1 rh_listcolumn_text">
                    <div class="fontbold rehub-main-font lineheight20">
                        <a rel="nofollow" target="_blank" class="re_track_btn no-color-link" href="<?php echo esc_url($afflink) ?>">
                ...
                <div class="rh_listcolumn rh_listcolumn_price text-center">
                    <?php if($offer_price) : ?>
                        <span class="price_count rehub-main-color rehub-main-font">
                    ...
                    <?php if ($stock_status_str): ?>
                        <div title="<?php _e('Last update was on: ', 'rehub-theme'); ?><?php echo TemplateHelper::getLastUpdateFormatted($item['module_id'], $post_id); ?>" class="cegg-lineheight15 blockstyle greencolor font80 stock-status status-<?php echo esc_attr($stock_status_class);?>">
