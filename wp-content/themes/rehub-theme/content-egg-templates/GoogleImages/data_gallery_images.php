...
<div class="justified-gallery rh-tilled-gallery modulo-lightbox five-thumbnails" data-galleryid="rhgal_<?php echo (int)$random_key;?>">
    ...
    <?php foreach ($items as $item): ?>
        ...
        <?php if (!empty ($gallery_image)) :?>
            <a data-rel="rhgal_<?php echo (int)$random_key;?>" href="<?php echo esc_url($gallery_image) ;?>" class="mb10" target="_blank" rel="nofollow" data-thumb="<?php echo esc_url($gallery_image) ;?>" data-title="<?php echo esc_attr($offer_title);?>"> 
