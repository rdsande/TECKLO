...
<?php if(!empty($all_items)):?>
    ...
    <div class="widget_merchant_list<?php if ($countitems > 7):?> expandme<?php endif;?>">
        <div class="tabledisplay">
            <?php  foreach ($all_items as $key => $item): ?>
                ...
                <?php if(rehub_option('rehub_btn_text') !='') :?><?php $btn_txt = rehub_option('rehub_btn_text') ; ?><?php else :?><?php $btn_txt = __('See it', 'rehub-theme') ;?><?php endif ;?>  
        ...
        <div class="additional_line_merchant flowhidden">
            <?php if ($countitems > 7):?>
            <span class="expand_all_offers"><?php _e('Show all', 'rehub-theme');?> <span class="expandme">+</span></span>
            <?php endif;?>
            <?php if ($unique_id && $module_id && !empty($syncitem)) {
    ...
    <?php if($product_update):?>
        <div class="font60 lineheight20"><?php _e('Last Amazon price update was:', 'rehub-theme');?> <?php echo esc_html($product_update);?> <span class="csspopuptrigger" data-popup="ce-widgetamazon-disclaimer"><i class="far fa-question-circle greycolor font110"></i></span></div>
