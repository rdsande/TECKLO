...
<?php foreach ($items as $item): ?>
    ...
    <table class="rh-tabletext-block">
        <tr>
        <th class="rh-tabletext-block-heading" colspan="2"><?php _e('Price history for ', 'rehub-theme');?><?php echo esc_attr($item['title']); ?></th>
        </tr>
        <tr>
        <td class="rh-tabletext-block-left">
            ...
            <?php if ($since): ?>
                <?php _e('Since:', 'rehub-theme');?> <?php echo date(get_option('date_format'), $since); ?>
            <?php endif; ?>                    
            </div>
        </td>
