...
<?php foreach ($items as $item): ?>
    ...
    <?php if(rehub_option('rehub_btn_text') !='') :?><?php $btn_txt = rehub_option('rehub_btn_text') ; ?><?php else :?><?php $btn_txt = __('Buy this item', 'rehub-theme') ;?><?php endif ;?>
    ...
    <div class="rehub_woo_review compact_w_deals">
        <?php if (!empty ($features) || !empty ($gallery_images)) :?>
            <ul class="rehub_woo_tabs_menu">
                ...
                <?php if (!empty ($features)) :?><li class="contaffdesc"><?php _e('Features', 'rehub-theme') ?></li><?php endif ;?>
                <?php if (!empty ($gallery_images)) :?><li class="pretty_woo"><?php _e('Photos', 'rehub-theme') ?></li><?php endif ;?>
            </ul>
        <?php endif ;?>
                    ...
                    <div class="listbuild_image listitem_column text-center">   
                        ...
                        <?php if (!empty($item['extra']['itemLinks'][3])): ?>
                            <span class="add_wishlist_ce">
                                <a href="<?php echo esc_url($item['extra']['itemLinks'][3]['URL']);?>" rel="nofollow" target="_blank" ><i class="far fa-heart"></i></a>
                            </span>
                        <?php endif; ?>                    
                    </div>
                    <div class="rh-flex-grow1 listitem_title listitem_column">
                        ...
                        <small class="small_size">
                            ...
                            <?php if ((bool) $item['extra']['IsEligibleForSuperSaverShipping']): ?>
                                <?php _e('& Free shipping', 'rehub-theme'); ?>
                            <?php endif; ?>                         
                        </small> 
                        <div class="font80 rh_opacity_7"><?php _e('Last update was on: ', 'rehub-theme'); ?><?php echo TemplateHelper::getLastUpdateFormatted('Amazon', $post_id); ?></div>                               
                    </div>
                            ...
                            <div>
                                ...
                                <?php if(!empty($item['extra']['coupon']['code_date'])) : ?>
                                    ...
                                    elseif ($days == 0){
                                      ...
                                      $coupon_text = __('Coupon is Expired', 'rehub-theme');
                                ...
                                <?php  if(!empty($item['extra']['coupon']['code'])) : ?>
                                    ...
                                    <?php else :?>
                                        ...
                                        <div class="rehub_offer_coupon masked_coupon <?php if(!empty($item['extra']['coupon']['code_date'])) {echo ''.$coupon_style ;} ?>" data-clipboard-text="<?php echo esc_attr($item['extra']['coupon']['code']) ?>" data-codetext="<?php echo esc_attr($item['extra']['coupon']['code']) ?>" data-dest="<?php echo esc_url($item['url']) ?>"><?php if(rehub_option('rehub_mask_text') !='') :?><?php echo rehub_option('rehub_mask_text') ; ?><?php else :?><?php _e('Reveal coupon', 'rehub-theme') ?><?php endif ;?><i class="far fa-external-link-square"></i></div>   
                                    <?php endif;?>
