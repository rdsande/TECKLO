<?php
/*
 * Name: Sorted list with store logo + group tabs
 * Modules:
...
{
    include(rh_locate_template('content-egg-templates/block_all_offers_logo.php'));
    return;
}
?>
...
<?php foreach ($groups as $i => $group): ?>
    ...
    <?php $group_ids[$i] = TemplateHelper::generateGlobalId('rh-cegg-offer-logo-'); ?>
