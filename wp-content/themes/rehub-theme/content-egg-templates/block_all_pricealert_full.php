    ...
    <?php if (TemplateHelper::isPriceAlertAllowed($unique_id, $module_id) && !empty($syncitem)): ?>
        ...
        <div class="price-alert-form-ce">
            <div class="alert-form-ce-wrap">
                <h4 id="<?php echo esc_attr($unique_id); ?>"><i class="far fa-bell bigbellalert rehub-main-color" aria-hidden="true"></i><?php _e('Didn\'t find the right price? Set price alert below', 'rehub-theme');?></h4>          
                <div class="cegg-price-alert-wrap">
                    <div class="mb10 font90">
                        <?php _e('Set Alert for Product', 'rehub-theme'); ?>: <?php echo esc_attr($syncitem['title']);?> - <?php echo TemplateHelper::formatPriceCurrency($offer_price, $currency_code); ?>
                    </div>              
                    <form>
                        ...
                        <div class="tabledisplay mobilecenterdisplay mobileblockdisplay flowhidden">
                            <div class="celldisplay pr15 rtlpl15">                    
                                <input type="email" name="email" placeholder="<?php _e('Your Email', 'rehub-theme'); ?>:" class="mb10" value="<?php if(method_exists('ContentEgg\application\helpers\TemplateHelper', 'getCurrentUserEmail')):?><?php echo esc_attr(TemplateHelper::getCurrentUserEmail()); ?><?php endif;?>">
                            </div>
                            <div class="celldisplay pr15 rtlpl15">
                                <input type="text" name="price" placeholder="<?php _e('Desired price', 'rehub-theme'); ?>:" class="mb10">
                            </div> 
                            <div class="celldisplay">
                                <input value="<?php _e('Start tracking', 'rehub-theme'); ?>" type="submit" class="wpsm-button rehub_main_btn small-btn floatright mb10" /> 
                            </div>                                
                        </div> 
