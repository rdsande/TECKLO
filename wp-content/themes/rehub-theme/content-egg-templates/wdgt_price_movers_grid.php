...
<div class="eq_grid post_eq_grid rh-flex-eq-height <?php echo esc_attr($col_wrap);?>">
...
<article class="col_item offer_grid mobile_compact_grid offer_grid_com no_btn_enabled"> 
    <div class="info_in_dealgrid">       
        <figure class="mb15">
            ...
            <a class="img-centered-flex rh-flex-center-align rh-flex-justify-center re_track_btn" href="<?php echo esc_attr($afflink);?>" rel="nofollow" target="_blank">
        ...
        <div class="grid_desc_and_btn">
            <div class="grid_row_info">
                ...
                <h3 class=""><a href="<?php echo esc_attr($afflink);?>" rel="nofollow" target="_blank" class="re_track_btn"><?php echo esc_attr($offer_title); ?></a></h3> 
            </div>
    ...
    <div class="meta_for_grid">
        <div class="date_for_grid floatleft mr5">
            <span class="date_ago">
                <i class="far fa-clock"></i><?php printf( __( '%s ago', 'rehub-theme' ), human_time_diff( $item['_price_movers']['create_date'], current_time( 'timestamp' ) ) ); ?>
            </span>        
        </div>        
