...
<div class="rh_listoffers">
    <?php  foreach ($all_items as $key => $item): ?>
        ...
        <?php if(rehub_option('rehub_btn_text') !='') :?><?php $btn_txt = rehub_option('rehub_btn_text') ; ?><?php else :?><?php $btn_txt = __('Buy Now', 'rehub-theme') ;?><?php endif ;?> 
        ...
        <div class="rh_listofferitem rh_list_mbl_im_left border-grey-bottom module_class_<?php echo esc_attr($modulecode);?> rh_stock_<?php echo esc_attr($stock_status_class);?>"> 
            <div class="rh-flex-center-align rh-flex-justify-center pt15 pb15 mobileblockdisplay">              
                ...
                <div class="rh_listcolumn rh-flex-grow1 rh_listcolumn_text">
                    <a rel="nofollow" target="_blank" class="re_track_btn font100 no-color-link blockstyle rehub-main-font lineheight20" href="<?php echo esc_url($afflink) ?>">
                ...
                <div class="rh_listcolumn rh_listcolumn_price text-center">
                    <?php if($offer_price) : ?>
                        <span class="price_count rehub-main-color rehub-main-font fontbold">
                        ...
                        <?php if($modulecode == 'Amazon'):?>
                            ...
                            <div class="font60 lineheight15"><?php echo TemplateHelper::getLastUpdateFormattedAmazon($data);?>
                                ...
                                <span class="csspopuptrigger" data-popup="ce-amazon-disclaimer<?php echo esc_attr($pop);?>"><i class="far fa-question-circle greycolor"></i></span></div>
                                <div class="csspopup" id="ce-amazon-disclaimer<?php echo esc_attr($pop);?>">
                                    <div class="csspopupinner">
                                        <span class="cpopupclose">×</span>
                                        <?php _e('Product prices and availability are accurate as of the date/time indicated and are subject to change. Any price and availability information displayed on Amazon.com (Amazon.in, Amazon.co.uk, Amazon.de, etc) at the time of purchase will apply to the purchase of this product.', 'rehub-theme');?>
                                    </div>                                
                                </div>
                            <?php if (!empty($item['extra']['totalNew'])): ?>
                                <div class="font60 lineheight15">
                                    <?php echo (int)$item['extra']['totalNew']; ?>
                                    <?php _e('new', 'rehub-theme'); ?> 
                                    <?php if ($item['extra']['lowestNewPrice']): ?>
                                         <?php _e('from', 'rehub-theme'); ?> <?php echo TemplateHelper::formatPriceCurrency($lowestnew_price, $currency_code); ?>
                                    <?php endif; ?>
                                </div>
                            <?php endif; ?>                            
                            <?php if (!empty($item['extra']['totalUsed'])): ?>
                                ...
                                <?php _e('used', 'rehub-theme'); ?> <?php _e('from', 'rehub-theme'); ?>
