...
<form action="/" method="get" id="form" name="form" accept-charset="utf-8">
    <p>
        <label><?php _e('Positives', 'rehub-theme') ;?></label>
        <textarea name="pos-text" id="pos-text" rows="4"></textarea><br /><small><?php _e('Separated by a new-line (by Enter)', 'rehub-theme') ;?></small>
    </p>
    <p>
        <label><?php _e('Negatives', 'rehub-theme') ;?></label>
        <textarea name="neg-text" id="neg-text" rows="4"></textarea><br /><small><?php _e('Separated by a new-line (by Enter)', 'rehub-theme') ;?></small>
    </p>
    <input id="pros-title" name="pros-title" type="hidden" value="<?php _e('PROS:', 'rehub-theme') ;?>" />
    <input id="cons-title" name="cons-title" type="hidden" value="<?php _e('CONS:', 'rehub-theme') ;?>" />    
	 <p>
        <label>&nbsp;</label>
