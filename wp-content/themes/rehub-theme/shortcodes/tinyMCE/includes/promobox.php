...
<form action="/" method="get" id="form" name="form" accept-charset="utf-8">
	<p>
		<label for="promoBoxback"><?php _e('Background-color :', 'rehub-theme') ;?></label>
		<select id="promoBoxback" name="promoBoxback">
			<option value="#f8f8f8"><?php _e('Grey', 'rehub-theme') ;?></option>			
			<option value="#ffffff"><?php _e('White', 'rehub-theme') ;?></option>
		</select>
	</p>
    
    <p>
		<label for="promoBoxborder"><?php _e('Show border?', 'rehub-theme') ;?></label>
		<input id="promoBoxborder" name="promoBoxborder" type="checkbox" class="checks" value="false" />
	</p>
    
    <p class="bordercheck half_left">
		<label for="promoBoxbordersize"><?php _e('Border size :', 'rehub-theme') ;?></label>
    ...
    <p class="bordercheck half_left second_half">
		<label for="promoBoxbordercolor"><?php _e('Border color :', 'rehub-theme') ;?></label>
        <select id="promoBoxbordercolor" name="promoBoxbordercolor">
			<option value="#dddddd"><?php _e('grey', 'rehub-theme') ;?></option>			
			<option value="#fb7203"><?php _e('orange', 'rehub-theme') ;?></option>
            <option value="#000000"><?php _e('black', 'rehub-theme') ;?></option>
		</select>
	</p>
	<div class="clear"></div>
    
    <p>
		<label for="promoBoxhighlightcheck"><?php _e('Show highlight border?', 'rehub-theme') ;?> </label>
    ...
    <p class="highlightcheck half_left">
		<label for="promoBoxhighlightcolor"><?php _e('Highlight color :', 'rehub-theme') ;?></label>
    ...
    <p class="highlightcheck half_left second_half">
		<label for="promoBoxhighlightpos"><?php _e('Highlight position :', 'rehub-theme') ;?></label>
        <select id="promoBoxhighlightpos" name="promoBoxhighlightpos">
            <option value="left"><?php _e('left', 'rehub-theme') ;?></option>			
            <option value="top"><?php _e('top', 'rehub-theme') ;?></option>			
            <option value="right"><?php _e('right', 'rehub-theme') ;?></option>
            <option value="bottom"><?php _e('bottom', 'rehub-theme') ;?></option>
		</select>
	</p>
    <div class="clear"></div>
   <p>
		<label for="promoBoxbtn"><?php _e('Show button?', 'rehub-theme') ;?></label>
		<input id="promoBoxbtn" name="promoBoxbtn" type="checkbox" class="checks" value="false" />
	</p>

    <p class="btncheck">
		<label for="promoBoxbtnlink"><?php _e('Button link :', 'rehub-theme') ;?></label>
		<input id="promoBoxbtnlink" name="promoBoxbtnlink" type="text" value="" />
	</p> 
    
    <p class="btncheck">
		<label for="promoBoxbtntext"><?php _e('Button text :', 'rehub-theme') ;?></label>
		<input id="promoBoxbtntext" name="promoBoxbtntext" type="text" value="Purchase Now" />
	</p>   

	<p>
		<label for="promoBoxtitle"><?php _e('Title of box :', 'rehub-theme') ;?></label>
		<input id="promoBoxtitle" name="promoBoxtitle" type="text" value="" />
	</p>
    
    	<p>
		<label for="promoBoxcontent"><?php _e('Box content :', 'rehub-theme') ;?></label>
