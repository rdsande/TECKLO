...
<form action="/" method="get" id="form" name="form" accept-charset="utf-8">	
	<p>
		<label for="colortable"><?php _e('Color of heading table :', 'rehub-theme') ;?></label>
		<select id="colortable" name="colortable">
			<option value="main-color"><?php _e('Main theme color', 'rehub-theme') ;?></option>
			<option value="sec-color"><?php _e('Secondary theme color', 'rehub-theme') ;?></option>			
			<option value="grey"><?php _e('grey', 'rehub-theme') ;?></option>
    ...
    <p>
		<label for="TableContent"><?php _e('Content :', 'rehub-theme') ;?></label>
