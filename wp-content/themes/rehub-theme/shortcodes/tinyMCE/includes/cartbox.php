...
<div>
    <p>
        <label><?php _e('Title', 'rehub-theme') ;?></label>
        <input type="text" name="button-title" value="" id="button-title" /><br />
    </p>
	<div class="clear"></div>
    <p>
        <label><?php _e('Link url', 'rehub-theme') ;?></label>
        <input type="text" name="button-link" value="" id="button-link" /><br />
        <small><?php _e('Will be used in title and image', 'rehub-theme') ;?></small>
    </p>
	<div class="clear"></div>
    <p>
        <label><?php _e('Description', 'rehub-theme') ;?></label>
        <input type="text" name="button-description" value="" id="button-description" /><br />
    </p>
    <p>	<label><?php _e('Make background contain?', 'rehub-theme') ;?></label>
        <input id="button-bg_contain" name="button-bg_contain" type="checkbox" class="checks" value="false" /></p>
    <div class="clear"></div>
	<div class="clear"></div>		
    <p>
        <label><?php _e('Image url', 'rehub-theme') ;?></label>
