...
<form action="/" method="get" id="form" name="form" accept-charset="utf-8">
	...
	<p><label><?php _e('Float', 'rehub-theme') ;?></label>
       	<select name="quote-float" id="quote-float" size="1">
			...
			<option value="none"><?php _e('none', 'rehub-theme') ;?></option>
        </select>
    </p>  
    <p><label><?php _e('Width (with %)', 'rehub-theme') ;?></label>
