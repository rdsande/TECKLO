...
<form action="/" method="get" id="form" name="form" accept-charset="utf-8">
	<p>
		<label for="VideoUrl"><?php _e('Video Url :', 'rehub-theme') ;?></label>
		<input id="VideoUrl" name="VideoUrl" type="text" value="http://" />

	</p>	
	<p id="scheck">
		<label for="formatcheck"><?php _e('With schema?', 'rehub-theme') ;?> </label>
		<input id="formatcheck" name="formatcheck" type="checkbox" class="checks" value="false"/>
	</p>
	<p class="schecklive">
		<label for="videotitle"><?php _e('Title of video :', 'rehub-theme') ;?></label>
		<input id="videotitle" name="videotitle" type="text" value="" />
	</p>
	<p class="schecklive">
		<label for="videodesc"><?php _e('Description of video :', 'rehub-theme') ;?></label>
		<input id="videodesc" name="videodesc" type="text" value="" />
	</p>
	<p>
		<label for="width"><?php _e('Width (with px):', 'rehub-theme') ;?></label>
		<input style="width:70px;" id="width" name="width" type="text" value="" />
	</p>
	<p>
		<label for="height"><?php _e('Height (with px):', 'rehub-theme') ;?></label>
		<input style="width:70px;"  id="height" name="height" type="text" value="" />
	</p>
	<p><small><?php _e('You can leave blank width and height for using default value', 'rehub-theme') ;?></small></p>		
	 <p>
        <label>&nbsp;</label>
