...
<form action="/" method="get" id="form" name="form" accept-charset="utf-8">
    <p><label><?php _e('Add products', 'rehub-theme') ;?></label>
        <input type="text" name="woocompare-ids" value="" id="woocompare-ids" /><br />
		<small></small>
    </p> 
	<p><label><?php _e('Logo', 'rehub-theme') ;?></label>
       	<select name="logo" id="logo" size="1">
			<option value="vendor" selected="selected"><?php _e('Vendor', 'rehub-theme') ;?></option>
			<option value="product"><?php _e('product', 'rehub-theme') ;?></option>
			<option value="brand"><?php _e('brand', 'rehub-theme') ;?></option>			
        </select>
    </p>     
	<p>
		<label><?php _e('Disable title of products?', 'rehub-theme') ;?></label>
