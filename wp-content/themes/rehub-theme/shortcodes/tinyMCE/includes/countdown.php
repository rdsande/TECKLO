...
<form action="/" method="get" id="form" name="form" accept-charset="utf-8">
	<p>
		<label for="count_year"><?php _e('Year of countdown finish :', 'rehub-theme') ;?></label>
		<input id="count_year" name="count_year" type="text" value="" />
		<small><?php _e('Example - 2015', 'rehub-theme') ;?></small>
	</p>
	<p>
		<label for="count_month"><?php _e('Month of countdown finish :', 'rehub-theme') ;?></label>
		<input id="count_month" name="count_month" type="text" value="" />
		<small><?php _e('Example - 6. Note! Without zero in start', 'rehub-theme') ;?></small>
	</p>
	<p>
		<label for="count_day"><?php _e('Day of countdown finish :', 'rehub-theme') ;?></label>
		<input id="count_day" name="count_day" type="text" value="" />
		<small><?php _e('Example - 6', 'rehub-theme') ;?></small>
	</p>
	<p>
		<label for="count_hour"><?php _e('Hour of countdown finish :', 'rehub-theme') ;?></label>
		<input id="count_hour" name="count_hour" type="text" value="" />
		<small><?php _e('Example - 12', 'rehub-theme') ;?></small>
	</p>			
	 <p>
        <label>&nbsp;</label>
