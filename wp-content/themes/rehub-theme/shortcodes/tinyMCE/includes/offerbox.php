...
<form action="/" method="get" id="form" name="form" accept-charset="utf-8">
    ...
    <p class="half_left">
		<label for="offerBoxprice"><?php _e('Offer sale price', 'rehub-theme') ;?></label>
		<input id="offerBoxprice" name="offerBoxprice" type="text" value="" />
	</p>
    <p class="half_left second_half">
		<label for="offerBoxpriceold"><?php _e('Offer old price', 'rehub-theme') ;?></label>
		<input id="offerBoxpriceold" name="offerBoxpriceold" type="text" value="" />
	</p>	
	<div class="clear"></div>
    <p>
		<label for="offerBoxbtnlink"><?php _e('Button link :', 'rehub-theme') ;?></label>
		<input id="offerBoxbtnlink" name="offerBoxbtnlink" type="text" value="" />
	</p> 
    
    <p>
		<label for="offerBoxbtntext"><?php _e('Button text :', 'rehub-theme') ;?></label>
		<input id="offerBoxbtntext" name="offerBoxbtntext" type="text" value="" />
	</p>   

	<p>
		<label for="offerBoxtitle"><?php _e('Title of offer :', 'rehub-theme') ;?></label>
		<input id="offerBoxtitle" name="offerBoxtitle" type="text" value="" />
	</p>
    
    <p>
		<label for="offerBoxcontent"><?php _e('OfferBox description:', 'rehub-theme') ;?></label>
		<textarea id="offerBoxcontent" name="offerBoxcontent" type="text" col="10" value=""></textarea>
	</p>
	<p>
		<label for="offerBoximg"><?php _e('Offer thumbnail url', 'rehub-theme') ;?></label>
		<input id="offerBoximg" name="offerBoximg" type="text" value="" />
		<small><?php _e('You can leave this field blank', 'rehub-theme') ;?></small>
	</p>
	<p>
		<label for="offerBoximglogo"><?php _e('Brand logo url', 'rehub-theme') ;?></label>
		<input id="offerBoximglogo" name="offerBoximglogo" type="text" value="" />
		<small><?php _e('You can leave this field blank', 'rehub-theme') ;?></small>
	</p>
    <p>
		<label for="offerBoxcoupon"><?php _e('Set coupon code', 'rehub-theme') ;?></label>
		<input id="offerBoxcoupon" name="offerBoxcoupon" type="text" value="" />
	</p>
    <p>
		<label for="offerBoxcoupondate"><?php _e('Coupon End Date', 'rehub-theme') ;?></label>
		<input id="offerBoxcoupondate" name="offerBoxcoupondate" type="text" value="" />
		<small><?php _e('Format date-month-year. Example, 20-12-2015', 'rehub-theme') ;?></small>
	</p>
	<p>
		<label><?php _e('Mask coupon code?', 'rehub-theme') ;?></label>
