...
<form action="/" method="get" id="form" name="form" accept-charset="utf-8">
	<p>
		<label><?php _e('Create new section', 'rehub-theme') ;?></label>
		<select name="price-new" id="price-new" size="1">
            <option value="no" selected="selected"><?php _e('No', 'rehub-theme') ;?></option>
            <option value="yes"><?php _e('Yes', 'rehub-theme') ;?></option>
        </select>
	</p>
	<p><label><?php _e('Column size', 'rehub-theme') ;?></label>
	...
	<p>
		<label><?php _e('Featured', 'rehub-theme') ;?></label>
	...
	<p><label><?php _e('Name', 'rehub-theme') ;?></label>
        <input type="text" name="price-name" value="" id="price-name" />
    </p>
	
	<p><label><?php _e('Price', 'rehub-theme') ;?></label>
		...
		<br />
		<small><?php _e('Example: $99.95 / month', 'rehub-theme') ;?></small>
    </p>
    	<p>
		...
		<select name="price-button_color" id="price-button_color" size="1">
			...
			<option value="orange" selected="selected"><?php _e('Orange', 'rehub-theme') ;?></option>
	...
	<p><label><?php _e('Button URL', 'rehub-theme') ;?></label>
        <input type="text" name="price-button_url" value="" id="price-button_url" />
    </p>
	<p><label><?php _e('Button text', 'rehub-theme') ;?></label>
        <input type="text" name="price-button_text" value="" id="price-button_text" />
    </p>
	
	<p><label><?php _e('List of items', 'rehub-theme') ;?></label>
        <textarea name="price-content" id="price-content" rows="6" /></textarea><br /><small><?php _e('Separated by a new-line (press Enter)', 'rehub-theme') ;?></small>
    </p>
	 <p>
        <label>&nbsp;</label>
