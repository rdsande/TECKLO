...
<form action="/" method="get" id="form" name="form" accept-charset="utf-8">
	...
	<p>
		<label for="Text"><?php _e('Content of tooltip', 'rehub-theme') ;?></label>
		<input id="Text" name="Text" type="Text" value="Sample title" />
	</p>
	<p>
		<label for="Gravities"><?php _e('Gravities :', 'rehub-theme') ;?></label>
		<select id="Gravities" name="Gravities">
			<option value="nw"><?php _e('Northwest', 'rehub-theme') ;?></option>
			<option value="n"><?php _e('North', 'rehub-theme') ;?></option>
			<option value="ne"><?php _e('Northeast', 'rehub-theme') ;?></option>
			<option value="w"><?php _e('West', 'rehub-theme') ;?></option>
			<option value="e"><?php _e('East', 'rehub-theme') ;?></option>
			<option value="sw" selected="selected"><?php _e('Southwest', 'rehub-theme') ;?></option>
			<option value="s"><?php _e('South', 'rehub-theme') ;?></option>
			<option value="se"><?php _e('Southeast', 'rehub-theme') ;?></option>
		</select>
	</p>
	<p>
		<label for="Content"><?php _e('Content :', 'rehub-theme') ;?> </label>
