...
<form action="/" method="get" id="form" name="form" accept-charset="utf-8">
	...
	<p>
		<label for="ImgUrl"><?php _e('Full Image or Youtube Video URL : ', 'rehub-theme') ;?></label>
		<input id="ImgUrl" name="ImgUrl" type="text" value="http://" />

	</p>
	<p>
		<label for="ImgTitle"><?php _e('Title for link:', 'rehub-theme') ;?> </label>
		<input id="ImgTitle" name="ImgTitle" type="text" value="" />

	</p>
	<p>
		<label for="ImgContent"><?php _e('Content :', 'rehub-theme') ;?> </label>
