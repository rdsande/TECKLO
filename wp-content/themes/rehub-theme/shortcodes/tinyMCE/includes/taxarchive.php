...
<form action="/" method="get" id="form" name="form" accept-charset="utf-8">
	<p>
        <label><?php _e('Taxonomy', 'rehub-theme') ;?></label>
	...
	<p>
        <label><?php _e('Child of', 'rehub-theme') ;?></label>
	...
	<p>
		...
		<select name="taxarchive-type" id="taxarchive-type" size="1">
            <option value="compactbig" selected="selected"><?php _e('Compact Blocks', 'rehub-theme') ;?></option>	
            <option value="compact"><?php _e('Compact small Blocks', 'rehub-theme') ;?></option>
            <option value="logo"><?php _e('Logo', 'rehub-theme') ;?></option>
            <option value="alpha"><?php _e('Alphabet', 'rehub-theme') ;?></option>  
            <option value="storegrid"><?php _e('Store Grid', 'rehub-theme') ;?></option> 
            <option value="woocategory"><?php _e('Woocommerce Category archive', 'rehub-theme') ;?></option>
            <option value="postcategory"><?php _e('Post category archive', 'rehub-theme') ;?></option>         
        </select>
	...
	<p>
		<label><?php _e('Columns', 'rehub-theme') ;?></label>
	...
	<p>
        <label><?php _e('Limit (Number)', 'rehub-theme') ;?></label>
        <input type="text" name="taxarchive-limit" value="" id="taxarchive-limit" /><br />
    </p>		

	<p>
        <label><?php _e('Image height', 'rehub-theme') ;?></label>
	...
	<p>
        <label><?php _e('Include', 'rehub-theme') ;?></label>
