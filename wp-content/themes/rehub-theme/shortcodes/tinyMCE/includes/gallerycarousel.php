...
<form action="/" method="get" id="form" name="form" accept-charset="utf-8">
    ...
    <p><label><?php _e('Images ids', 'rehub-theme') ;?></label>
        <input type="text" name="minigallery-ids" value="" id="minigallery-ids" /><br />
        <small><?php _e('Insert ids of images with commas.', 'rehub-theme') ;?>. <a href="http://rehub.wpsoul.com/documentation/docs.html#51" target="_blank">Tip - How to get images ids very fast</a></small>
    </p> 
    <p>
        <label><?php _e('Enable prettyphoto?', 'rehub-theme') ;?></label>
