...
<form action="/" method="get" id="form" name="form" accept-charset="utf-8">
	<p><label><?php _e('Number', 'rehub-theme') ;?></label>
        <input type="text" name="numhead-num" value="1" id="numhead-num" />
    </p>
	
	<p><label><?php _e('Style of number', 'rehub-theme') ;?></label>
       	<select name="numhead-style" id="numhead-style" size="1">
			<option value="1"><?php _e('Grey', 'rehub-theme') ;?></option>
			<option value="2"><?php _e('Black', 'rehub-theme') ;?></option>
			<option value="3" selected="selected"><?php _e('Orange', 'rehub-theme') ;?></option>
			<option value="4"><?php _e('Blue', 'rehub-theme') ;?></option>
        </select>
    </p> 
	<p><label><?php _e('Heading', 'rehub-theme') ;?></label>
    ...
    <p>
        <label><?php _e('Text', 'rehub-theme') ;?></label>
