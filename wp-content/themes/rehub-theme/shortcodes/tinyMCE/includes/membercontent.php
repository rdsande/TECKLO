...
<form action="/" method="get" id="form" name="form" accept-charset="utf-8">
	<p>
        <label><?php _e('Text for guests', 'rehub-theme') ;?></label>
        <input type="text" name="member-guest" value="" id="member-guest" /><br />
        <small><?php _e('Or live blank for default text', 'rehub-theme') ;?></small>
    </p>
    <p>
        <label><?php _e('Text for members', 'rehub-theme') ;?></label>
