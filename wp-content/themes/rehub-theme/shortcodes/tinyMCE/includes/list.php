...
<form action="/" method="get" id="form" name="form" accept-charset="utf-8">
	<p>
		...
		<select name="list-type" id="list-type" size="1">
            <option value="arrow" selected="selected"><?php _e('Arrow', 'rehub-theme') ;?></option>
            <option value="check"><?php _e('Check', 'rehub-theme') ;?></option>
			<option value="star"><?php _e('Star', 'rehub-theme') ;?></option>
			<option value="bullet"><?php _e('Bullet', 'rehub-theme') ;?></option>			
        </select>
	</p>
    <p>
        <label><?php _e('List Text', 'rehub-theme') ;?></label>
        <textarea name="list-text" id="list-text" rows="6"></textarea><br /><small><?php _e('Separated by a new-line (by Enter)', 'rehub-theme') ;?></small>
    </p>
	<p class="half_left">
		<label><?php _e('Pretty hover?', 'rehub-theme') ;?></label>
        <input id="list-hover" name="list-hover" type="checkbox" class="checks" value="false" />
	</p> 
	<p class="half_left second_half">
		<label><?php _e('Make links dark?', 'rehub-theme') ;?></label>
        <input id="list-dark" name="list-dark" type="checkbox" class="checks" value="false" />
	</p> 
	<p>
		<label><?php _e('Make small gap between items?', 'rehub-theme') ;?></label>
