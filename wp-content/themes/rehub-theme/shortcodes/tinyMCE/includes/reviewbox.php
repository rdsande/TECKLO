...
<form action="/" method="get" id="form" name="form" accept-charset="utf-8">
    ...
    <p>
		<label for="reviewBoxtitle"><?php _e('Review heading', 'rehub-theme') ;?></label>
		<input id="reviewBoxtitle" name="reviewBoxtitle" type="text" value="" />
	</p> 				
    <p>
		<label for="reviewBoxcontent"><?php _e('Review short description', 'rehub-theme') ;?></label>
		<textarea id="reviewBoxcontent" name="reviewBoxcontent" rows="6"></textarea>
	</p>
    <p>
		<label for="reviewBoxcriterias"><?php _e('Review criterias', 'rehub-theme') ;?></label>
	...
	<p>
		<label for="reviewBoxscore"><?php _e('Review manual score', 'rehub-theme') ;?></label>
    ...
    <p>
		<label for="reviewBoxpros"><?php _e('Review pros', 'rehub-theme') ;?></label>
		<textarea id="reviewBoxpros" name="reviewBoxpros" rows="6"></textarea>	
		<small>Set each pros from next line</small>			
	</p>
    <p>
		<label for="reviewBoxcons"><?php _e('Review cons', 'rehub-theme') ;?></label>
