...
<div class="shortcode_loop">
	<p>
		<label><?php _e('Title of section', 'rehub-theme') ;?></label>
          <input type="text" name="accordion-title" value="Sample title" class="accordion-title" />
        </select>
	</p>
	<p>
		<label><?php _e('Content', 'rehub-theme') ;?></label>
	...
	<p>
		<strong><a style="cursor: pointer;" id="add-tab">+ <?php _e('Add Accordition', 'rehub-theme') ;?></a></strong>
	</p>
	 <p>
        <label>&nbsp;</label>
