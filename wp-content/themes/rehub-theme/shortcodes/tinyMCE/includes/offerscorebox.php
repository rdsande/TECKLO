...
<form action="/" method="get" id="form" name="form" accept-charset="utf-8">
	...
	<p>
	<label for="offerid"><?php _e('Type post name', 'rehub-theme') ;?></label>
	...
	<p>
		...
		<select name="offertype" id="offertype" size="1">
            <option value="ceoffer" selected="selected"><?php _e('Post box with comparison widget', 'rehub-theme') ;?></option>
            <option value="cemerchant"><?php _e('Content Egg merchants widget', 'rehub-theme') ;?></option>
            <option value="cewidget"><?php _e('Content Egg price widget', 'rehub-theme') ;?></option>
            <option value="cegrid"><?php _e('Content Egg grid', 'rehub-theme') ;?></option>
            <option value="celist"><?php _e('Content Egg list with offer images', 'rehub-theme') ;?></option>
            <option value="celistlogo"><?php _e('Content Egg list with logo images', 'rehub-theme') ;?></option>
            <option value="celistdef"><?php _e('Content Egg list with offer images (default style)', 'rehub-theme') ;?></option>
            <option value="celistdeflogo"><?php _e('Content Egg list with logo images (default style)', 'rehub-theme') ;?></option>
            <option value="cestat"><?php _e('Content Egg Price statistic', 'rehub-theme') ;?></option>
            <option value="cehistory"><?php _e('Content Egg price history', 'rehub-theme') ;?></option>
            <option value="cealert"><?php _e('Content Egg price alert', 'rehub-theme') ;?></option>                                                            
        </select>
	</p>				
