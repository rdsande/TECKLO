		...
		<div class="rh_listofferitem rh_list_mbl_im_left border-grey-bottom">
			<div class="rh-flex-center-align rh-flex-justify-center pt15 pb15 mobileblockdisplay">
	            ...
	            <div class="rh_listcolumn rh-flex-grow1 rh_listcolumn_text">
					<a href="<?php echo esc_url($more_product['shop_link']); ?>" class="wcmp_seller_name no-color-link rehub-main-font blockstyle mb10 font90 lineheight15"><?php echo esc_attr($more_product['seller_name']); ?></a> 
					<?php 
	            ...
	            <div class="rh_listcolumn rh_listcolumn_price text-center"> 
	            	<span class="price_count rehub-main-color rehub-main-font"><?php echo ''.$_product->get_price_html(); ?></span>    
	            </div> 
	            <div class="text-right-align rh_listcolumn_btn">
					...
					<a href="<?php echo get_permalink($more_product['product_id']); ?>" class="font80 details-link-list" ><?php echo __('Details','rehub-theme'); ?></a>                
	            </div> 
            </div>                                							
