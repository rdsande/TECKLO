...
if (apply_filters('is_vendor_add_external_url_field', true, $vendor->id)) {
	...
	if (empty($external_store_label))
		$external_store_label = __('External Store URL', 'rehub-theme');
				...
				<div class="tabledisplay">
		    		...
		    		<div id="wcvendor_profile_act_btns" class="wcvendor_profile_cell">
		    			...
		    			<?php if(is_active_widget( '', '', 'dc-vendor-quick-info')):?>
							<span data-scrollto="#wcmp-vendor-contact-widget-top" class="wpsm-button medium white rehub_scroll"><?php _e('Contact vendor', 'rehub-theme') ;?></span>
	...
	<div id="wcvendor_profile_menu">
		<div class="rh-container litesearchstyle">	
			...
			<ul class="wcvendor_profile_menu_items">		
				...
				<li><a href="#vendor-about" aria-controls="vendor-about" role="tab" data-toggle="tab" aria-expanded="true" data-scrollto="#vendor-about"><?php _e('About', 'rehub-theme');?></a></li>
				<?php endif; ?>
			</ul>
		</div>
	</div>
			...
			<div class="rh-cartbox widget">
				<div>
					...
					<div class="profile-stats">
						<div><i class="far fa-user-circle"></i> <?php _e( 'Registration', 'rehub-theme' );  echo ': ' . date_i18n( get_option( "date_format" ), strtotime( $vendor->user_data->user_registered )); ?></div>
					...
					<div class="profile-description wcmp-profile-contacts">
						<span class="fontbold"><?php _e( 'Contact', 'rehub-theme' ); ?></span>
